var Da=a=>{throw TypeError(a)};var Ma=(a,t,e)=>t.has(a)||Da("Cannot "+e);var Ra=(a,t,e)=>(Ma(a,t,"read from private field"),e?e.call(a):t.get(a)),Oa=(a,t,e)=>t.has(a)?Da("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),Qe=(a,t,e,d)=>(Ma(a,t,"write to private field"),d?d.call(a,e):t.set(a,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))d(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&d(s)}).observe(document,{childList:!0,subtree:!0});function e(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function d(o){if(o.ep)return;o.ep=!0;const r=e(o);fetch(o.href,r)}})();/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const je=globalThis,xa=je.ShadowRoot&&(je.ShadyCSS===void 0||je.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ss=Symbol(),qa=new WeakMap;let Ks=class{constructor(t,e,d){if(this._$cssResult$=!0,d!==Ss)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(xa&&t===void 0){const d=e!==void 0&&e.length===1;d&&(t=qa.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),d&&qa.set(e,t))}return t}toString(){return this.cssText}};const Es=a=>new Ks(typeof a=="string"?a:a+"",void 0,Ss),Ys=(a,t)=>{if(xa)a.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const d=document.createElement("style"),o=je.litNonce;o!==void 0&&d.setAttribute("nonce",o),d.textContent=e.cssText,a.appendChild(d)}},Ha=xa?a=>a:a=>a instanceof CSSStyleSheet?(t=>{let e="";for(const d of t.cssRules)e+=d.cssText;return Es(e)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Xs,defineProperty:Qs,getOwnPropertyDescriptor:Zs,getOwnPropertyNames:to,getOwnPropertySymbols:eo,getPrototypeOf:ao}=Object,dt=globalThis,za=dt.trustedTypes,so=za?za.emptyScript:"",Ze=dt.reactiveElementPolyfillSupport,de=(a,t)=>a,Le={toAttribute(a,t){switch(t){case Boolean:a=a?so:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,t){let e=a;switch(t){case Boolean:e=a!==null;break;case Number:e=a===null?null:Number(a);break;case Object:case Array:try{e=JSON.parse(a)}catch{e=null}}return e}},wa=(a,t)=>!Xs(a,t),Ga={attribute:!0,type:String,converter:Le,reflect:!1,useDefault:!1,hasChanged:wa};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),dt.litPropertyMetadata??(dt.litPropertyMetadata=new WeakMap);let qt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Ga){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const d=Symbol(),o=this.getPropertyDescriptor(t,d,e);o!==void 0&&Qs(this.prototype,t,o)}}static getPropertyDescriptor(t,e,d){const{get:o,set:r}=Zs(this.prototype,t)??{get(){return this[e]},set(s){this[e]=s}};return{get:o,set(s){const l=o==null?void 0:o.call(this);r==null||r.call(this,s),this.requestUpdate(t,l,d)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ga}static _$Ei(){if(this.hasOwnProperty(de("elementProperties")))return;const t=ao(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(de("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(de("properties"))){const e=this.properties,d=[...to(e),...eo(e)];for(const o of d)this.createProperty(o,e[o])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[d,o]of e)this.elementProperties.set(d,o)}this._$Eh=new Map;for(const[e,d]of this.elementProperties){const o=this._$Eu(e,d);o!==void 0&&this._$Eh.set(o,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const d=new Set(t.flat(1/0).reverse());for(const o of d)e.unshift(Ha(o))}else t!==void 0&&e.push(Ha(t));return e}static _$Eu(t,e){const d=e.attribute;return d===!1?void 0:typeof d=="string"?d:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(e=>e(this))}addController(t){var e;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((e=t.hostConnected)==null||e.call(t))}removeController(t){var e;(e=this._$EO)==null||e.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const d of e.keys())this.hasOwnProperty(d)&&(t.set(d,this[d]),delete this[d]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ys(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(e=>{var d;return(d=e.hostConnected)==null?void 0:d.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(e=>{var d;return(d=e.hostDisconnected)==null?void 0:d.call(e)})}attributeChangedCallback(t,e,d){this._$AK(t,d)}_$ET(t,e){var r;const d=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,d);if(o!==void 0&&d.reflect===!0){const s=(((r=d.converter)==null?void 0:r.toAttribute)!==void 0?d.converter:Le).toAttribute(e,d.type);this._$Em=t,s==null?this.removeAttribute(o):this.setAttribute(o,s),this._$Em=null}}_$AK(t,e){var r,s;const d=this.constructor,o=d._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const l=d.getPropertyOptions(o),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((r=l.converter)==null?void 0:r.fromAttribute)!==void 0?l.converter:Le;this._$Em=o;const c=n.fromAttribute(e,l.type);this[o]=c??((s=this._$Ej)==null?void 0:s.get(o))??c,this._$Em=null}}requestUpdate(t,e,d,o=!1,r){var s;if(t!==void 0){const l=this.constructor;if(o===!1&&(r=this[t]),d??(d=l.getPropertyOptions(t)),!((d.hasChanged??wa)(r,e)||d.useDefault&&d.reflect&&r===((s=this._$Ej)==null?void 0:s.get(t))&&!this.hasAttribute(l._$Eu(t,d))))return;this.C(t,e,d)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:d,reflect:o,wrapped:r},s){d&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,s??e??this[t]),r!==!0||s!==void 0)||(this._$AL.has(t)||(this.hasUpdated||d||(e=void 0),this._$AL.set(t,e)),o===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var d;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,s]of this._$Ep)this[r]=s;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[r,s]of o){const{wrapped:l}=s,n=this[r];l!==!0||this._$AL.has(r)||n===void 0||this.C(r,void 0,s,n)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),(d=this._$EO)==null||d.forEach(o=>{var r;return(r=o.hostUpdate)==null?void 0:r.call(o)}),this.update(e)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(e)}willUpdate(t){}_$AE(t){var e;(e=this._$EO)==null||e.forEach(d=>{var o;return(o=d.hostUpdated)==null?void 0:o.call(d)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(e=>this._$ET(e,this[e]))),this._$EM()}updated(t){}firstUpdated(t){}};qt.elementStyles=[],qt.shadowRootOptions={mode:"open"},qt[de("elementProperties")]=new Map,qt[de("finalized")]=new Map,Ze==null||Ze({ReactiveElement:qt}),(dt.reactiveElementVersions??(dt.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const re=globalThis,Na=a=>a,Pe=re.trustedTypes,Ua=Pe?Pe.createPolicy("lit-html",{createHTML:a=>a}):void 0,js="$lit$",st=`lit$${Math.random().toFixed(9).slice(2)}$`,Fs="?"+st,oo=`<${Fs}>`,Et=document,ue=()=>Et.createComment(""),ge=a=>a===null||typeof a!="object"&&typeof a!="function",$a=Array.isArray,ro=a=>$a(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",ta=`[ 	
\f\r]`,ee=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Va=/-->/g,Wa=/>/g,bt=RegExp(`>|${ta}(?:([^\\s"'>=/]+)(${ta}*=${ta}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ja=/'/g,Ka=/"/g,Cs=/^(?:script|style|textarea|title)$/i,Bs=a=>(t,...e)=>({_$litType$:a,strings:t,values:e}),u=Bs(1),ft=Bs(2),jt=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),Ya=new WeakMap,kt=Et.createTreeWalker(Et,129);function Is(a,t){if(!$a(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ua!==void 0?Ua.createHTML(t):t}const io=(a,t)=>{const e=a.length-1,d=[];let o,r=t===2?"<svg>":t===3?"<math>":"",s=ee;for(let l=0;l<e;l++){const n=a[l];let c,h,v=-1,m=0;for(;m<n.length&&(s.lastIndex=m,h=s.exec(n),h!==null);)m=s.lastIndex,s===ee?h[1]==="!--"?s=Va:h[1]!==void 0?s=Wa:h[2]!==void 0?(Cs.test(h[2])&&(o=RegExp("</"+h[2],"g")),s=bt):h[3]!==void 0&&(s=bt):s===bt?h[0]===">"?(s=o??ee,v=-1):h[1]===void 0?v=-2:(v=s.lastIndex-h[2].length,c=h[1],s=h[3]===void 0?bt:h[3]==='"'?Ka:Ja):s===Ka||s===Ja?s=bt:s===Va||s===Wa?s=ee:(s=bt,o=void 0);const $=s===bt&&a[l+1].startsWith("/>")?" ":"";r+=s===ee?n+oo:v>=0?(d.push(c),n.slice(0,v)+js+n.slice(v)+st+$):n+st+(v===-2?l:$)}return[Is(a,r+(a[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),d]};class me{constructor({strings:t,_$litType$:e},d){let o;this.parts=[];let r=0,s=0;const l=t.length-1,n=this.parts,[c,h]=io(t,e);if(this.el=me.createElement(c,d),kt.currentNode=this.el.content,e===2||e===3){const v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(o=kt.nextNode())!==null&&n.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(const v of o.getAttributeNames())if(v.endsWith(js)){const m=h[s++],$=o.getAttribute(v).split(st),F=/([.?@])?(.*)/.exec(m);n.push({type:1,index:r,name:F[2],strings:$,ctor:F[1]==="."?no:F[1]==="?"?co:F[1]==="@"?po:Je}),o.removeAttribute(v)}else v.startsWith(st)&&(n.push({type:6,index:r}),o.removeAttribute(v));if(Cs.test(o.tagName)){const v=o.textContent.split(st),m=v.length-1;if(m>0){o.textContent=Pe?Pe.emptyScript:"";for(let $=0;$<m;$++)o.append(v[$],ue()),kt.nextNode(),n.push({type:2,index:++r});o.append(v[m],ue())}}}else if(o.nodeType===8)if(o.data===Fs)n.push({type:2,index:r});else{let v=-1;for(;(v=o.data.indexOf(st,v+1))!==-1;)n.push({type:7,index:r}),v+=st.length-1}r++}}static createElement(t,e){const d=Et.createElement("template");return d.innerHTML=t,d}}function Wt(a,t,e=a,d){var s,l;if(t===jt)return t;let o=d!==void 0?(s=e._$Co)==null?void 0:s[d]:e._$Cl;const r=ge(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==r&&((l=o==null?void 0:o._$AO)==null||l.call(o,!1),r===void 0?o=void 0:(o=new r(a),o._$AT(a,e,d)),d!==void 0?(e._$Co??(e._$Co=[]))[d]=o:e._$Cl=o),o!==void 0&&(t=Wt(a,o._$AS(a,t.values),o,d)),t}class lo{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:d}=this._$AD,o=((t==null?void 0:t.creationScope)??Et).importNode(e,!0);kt.currentNode=o;let r=kt.nextNode(),s=0,l=0,n=d[0];for(;n!==void 0;){if(s===n.index){let c;n.type===2?c=new xe(r,r.nextSibling,this,t):n.type===1?c=new n.ctor(r,n.name,n.strings,this,t):n.type===6&&(c=new vo(r,this,t)),this._$AV.push(c),n=d[++l]}s!==(n==null?void 0:n.index)&&(r=kt.nextNode(),s++)}return kt.currentNode=Et,o}p(t){let e=0;for(const d of this._$AV)d!==void 0&&(d.strings!==void 0?(d._$AI(t,d,e),e+=d.strings.length-2):d._$AI(t[e])),e++}}class xe{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,d,o){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=d,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Wt(this,t,e),ge(t)?t===g||t==null||t===""?(this._$AH!==g&&this._$AR(),this._$AH=g):t!==this._$AH&&t!==jt&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ro(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==g&&ge(this._$AH)?this._$AA.nextSibling.data=t:this.T(Et.createTextNode(t)),this._$AH=t}$(t){var r;const{values:e,_$litType$:d}=t,o=typeof d=="number"?this._$AC(t):(d.el===void 0&&(d.el=me.createElement(Is(d.h,d.h[0]),this.options)),d);if(((r=this._$AH)==null?void 0:r._$AD)===o)this._$AH.p(e);else{const s=new lo(o,this),l=s.u(this.options);s.p(e),this.T(l),this._$AH=s}}_$AC(t){let e=Ya.get(t.strings);return e===void 0&&Ya.set(t.strings,e=new me(t)),e}k(t){$a(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let d,o=0;for(const r of t)o===e.length?e.push(d=new xe(this.O(ue()),this.O(ue()),this,this.options)):d=e[o],d._$AI(r),o++;o<e.length&&(this._$AR(d&&d._$AB.nextSibling,o),e.length=o)}_$AR(t=this._$AA.nextSibling,e){var d;for((d=this._$AP)==null?void 0:d.call(this,!1,!0,e);t!==this._$AB;){const o=Na(t).nextSibling;Na(t).remove(),t=o}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class Je{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,d,o,r){this.type=1,this._$AH=g,this._$AN=void 0,this.element=t,this.name=e,this._$AM=o,this.options=r,d.length>2||d[0]!==""||d[1]!==""?(this._$AH=Array(d.length-1).fill(new String),this.strings=d):this._$AH=g}_$AI(t,e=this,d,o){const r=this.strings;let s=!1;if(r===void 0)t=Wt(this,t,e,0),s=!ge(t)||t!==this._$AH&&t!==jt,s&&(this._$AH=t);else{const l=t;let n,c;for(t=r[0],n=0;n<r.length-1;n++)c=Wt(this,l[d+n],e,n),c===jt&&(c=this._$AH[n]),s||(s=!ge(c)||c!==this._$AH[n]),c===g?t=g:t!==g&&(t+=(c??"")+r[n+1]),this._$AH[n]=c}s&&!o&&this.j(t)}j(t){t===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class no extends Je{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===g?void 0:t}}class co extends Je{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==g)}}class po extends Je{constructor(t,e,d,o,r){super(t,e,d,o,r),this.type=5}_$AI(t,e=this){if((t=Wt(this,t,e,0)??g)===jt)return;const d=this._$AH,o=t===g&&d!==g||t.capture!==d.capture||t.once!==d.once||t.passive!==d.passive,r=t!==g&&(d===g||o);o&&this.element.removeEventListener(this.name,this,d),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class vo{constructor(t,e,d){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=d}get _$AU(){return this._$AM._$AU}_$AI(t){Wt(this,t)}}const ea=re.litHtmlPolyfillSupport;ea==null||ea(me,xe),(re.litHtmlVersions??(re.litHtmlVersions=[])).push("3.3.2");const ho=(a,t,e)=>{const d=(e==null?void 0:e.renderBefore)??t;let o=d._$litPart$;if(o===void 0){const r=(e==null?void 0:e.renderBefore)??null;d._$litPart$=o=new xe(t.insertBefore(ue(),r),r,void 0,e??{})}return o._$AI(a),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wt=globalThis;let M=class extends qt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=ho(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return jt}};var As;M._$litElement$=!0,M.finalized=!0,(As=wt.litElementHydrateSupport)==null||As.call(wt,{LitElement:M});const aa=wt.litElementPolyfillSupport;aa==null||aa({LitElement:M});(wt.litElementVersions??(wt.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const xo={CHILD:2},wo=a=>(...t)=>({_$litDirective$:a,values:t});class $o{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,d){this._$Ct=t,this._$AM=e,this._$Ci=d}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Ao='@charset "UTF-8";:host{display:inline-flex}.jb{--_p: var(--brand, var(--gx));--_ph: var(--brand-h, var(--gx-h));--_on: var(--brand-on, var(--gx-on));--_a: var(--brand-a, var(--gx-a));--_f: var(--brand, var(--gx));--_sec-bg: #111;--_sec-on: #fff;--_sec-h-bg: color-mix(in srgb, var(--_p) 15%, #111);--_sec-h-on: #fff;--_ter-bg: #fff;--_ter-on: #111;--_ter-h-bg: color-mix(in srgb, var(--_p) 15%, #fff);--_ter-h-on: var(--_p);--_out-bd: var(--black);--_out-t: var(--black);--_txt: var(--black);--_dis-bg: var(--grey-200);--_dis-t: var(--grey-500);display:inline-flex;align-items:center;justify-content:center;gap:var(--sp-2);height:48px;padding:var(--sp-2) var(--sp-5);min-width:128px;font:var(--label);border:1px solid transparent;border-radius:var(--r-full);background:transparent;color:var(--_txt);cursor:pointer;outline:none;box-sizing:border-box;transition:background var(--duration-fast) var(--ease),color var(--duration-fast) var(--ease),border-color var(--duration-fast) var(--ease),box-shadow var(--duration-fast) var(--ease),transform var(--duration-fast) var(--ease)}.jb:active:not(:disabled){transform:scale(.97)}.jb:disabled{cursor:not-allowed}.jb:focus-visible{outline:2px solid var(--_f);outline-offset:2px}.jb__i{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;width:20px;height:20px}.jb__i ::slotted(svg){width:100%;height:100%}.jb__i[hidden]{display:none}.jb--has-icon{padding-inline-start:20px}.jb--pri{background:var(--_p);color:var(--_on)}.jb--pri:hover:not(:disabled){background:var(--_ph);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--pri:disabled{background:var(--_dis-bg);color:var(--_dis-t)}.jb--sec{background:var(--_sec-bg);color:var(--_sec-on)}.jb--sec:hover:not(:disabled){background:var(--_sec-h-bg);color:var(--_sec-h-on);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--sec:disabled{background:var(--_dis-bg);color:var(--_dis-t)}.jb--ter{background:var(--_ter-bg);color:var(--_ter-on);box-shadow:var(--shadow-sm)}.jb--ter:hover:not(:disabled){background:var(--_ter-h-bg);color:var(--_ter-h-on);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--ter:disabled{background:var(--_dis-bg);color:var(--_dis-t)}.jb--out{background:transparent;color:var(--_out-t);border-color:var(--_out-bd)}.jb--out:hover:not(:disabled){border-color:var(--grey-300);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--out:disabled{border-color:var(--_dis-bg);color:var(--_dis-t)}.jb--pln{background:transparent;color:var(--_txt);border:none;border-radius:0;min-width:auto;padding:var(--sp-2) 0}.jb--pln:hover:not(:disabled){text-decoration:underline;text-underline-offset:3px}.jb--pln:disabled{color:var(--_dis-t)}.jb--ico{background:transparent;color:var(--_txt);border:none;border-radius:var(--r-sm);min-width:auto;height:auto;padding:var(--sp-2);gap:0}.jb--ico:hover:not(:disabled){opacity:.7}.jb--ico:disabled{color:var(--_dis-t)}.jb--ico.jb--has-icon{padding-inline-start:var(--sp-2)}:host-context([data-surface=dark]) .jb{--_txt: #fff;--_out-bd: #fff;--_out-t: #fff;--_dis-bg: #2a2f35;--_dis-t: #707880}:host-context([data-surface=dark]) .jb--out:hover:not(:disabled){border-color:transparent;background:#ffffff14}:host-context([data-surface=dark]) .jb--out.jb--hover{border-color:transparent;background:#ffffff14}.jb--pri.jb--hover{background:var(--_ph);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--sec.jb--hover{background:var(--_sec-h-bg);color:var(--_sec-h-on);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--ter.jb--hover{background:var(--_ter-h-bg);color:var(--_ter-h-on);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--out.jb--hover{border-color:var(--grey-300);transform:translateY(-1px);box-shadow:var(--shadow-md)}.jb--pln.jb--hover{text-decoration:underline;text-underline-offset:3px}.jb--ico.jb--hover{opacity:.7}.jb.jb--focus{outline:2px solid var(--_f);outline-offset:2px}.jb.jb--active{transform:scale(.97)}.jb--pri.jb--active{background:var(--_ph);box-shadow:var(--shadow-md)}.jb--sec.jb--active{background:var(--_sec-h-bg);color:var(--_sec-h-on);box-shadow:var(--shadow-md)}.jb--ter.jb--active{background:var(--_ter-h-bg);color:var(--_ter-h-on);box-shadow:var(--shadow-md)}.jb--out.jb--active{border-color:var(--grey-300);box-shadow:var(--shadow-md)}.jb--pln.jb--active{text-decoration:underline;text-underline-offset:3px}.jb--ico.jb--active{opacity:.7}@media(prefers-reduced-motion:reduce){.jb{transition:none}}';var So=Object.defineProperty,Eo=Object.getOwnPropertyDescriptor,Tt=(a,t,e,d)=>{for(var o=d>1?void 0:d?Eo(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&So(t,e,o),o};let it=class extends J{constructor(){super(...arguments),this.variant="primary",this.disabled=!1,this.label="",this.iconOnly=!1,this.forceState="",this._hasIcon=!1}_variantClass(){return{primary:"jb--pri",secondary:"jb--sec",tertiary:"jb--ter",outline:"jb--out",plain:"jb--pln",icon:"jb--ico"}[this.variant]??"jb--pri"}_onIconSlotChange(a){const t=a.target;this._hasIcon=t.assignedNodes({flatten:!0}).length>0}render(){const a=this.forceState,t=`jb ${this._variantClass()}${this._hasIcon?" jb--has-icon":""}${a?" jb--"+a:""}`;return u`
      ...
      <div class=${a}>
        ...
        <div class="lam-eyebrow__body">
          ...
          ${this.showCta?u`
              ...
              <a class="lam-eyebrow__cta" href=${this.ctaHref}>${this.ctaText} <span class="lam-eyebrow__chevron">${Io}</span></a>
            `:g}
        </div>
      </div>
    `}};Lt([b({type:Boolean,attribute:"show-icon"})],lt.prototype,"showIcon",2);Lt([b({type:String,attribute:"tag-text"})],lt.prototype,"tagText",2);Lt([b({type:String,attribute:"body-text"})],lt.prototype,"bodyText",2);Lt([b({type:String,attribute:"cta-text"})],lt.prototype,"ctaText",2);Lt([b({type:String,attribute:"cta-href"})],lt.prototype,"ctaHref",2);Lt([b({type:Boolean,attribute:"show-cta"})],lt.prototype,"showCta",2);lt=Lt([W({tag:"june-eyebrow",styles:jo})],lt);const To=":host{display:block}.blk{display:flex;flex-direction:column;gap:var(--sp-8);padding:var(--sp-10);background:var(--card)}.blk__header{display:flex;flex-direction:column;gap:var(--sp-4)}.blk__header--center{align-items:center;text-align:center}.blk__content{display:flex;flex-direction:column;gap:var(--sp-8)}.blk__grid{display:grid;grid-template-columns:repeat(2,1fr);gap:var(--sp-8)}.blk__grid--3col{grid-template-columns:repeat(3,1fr)}.blk--left{flex-direction:row;align-items:flex-start}.blk--left .blk__header{flex:0 0 400px;position:sticky;inset-block-start:var(--sp-5)}.blk--left .blk__content{flex:1}";var Lo=Object.defineProperty,Po=Object.getOwnPropertyDescriptor,Qt=(a,t,e,d)=>{for(var o=d>1?void 0:d?Po(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Lo(t,e,o),o};let Ft=class extends J{constructor(){super(...arguments),this.align="top",this.columns=2,this.showHeader=!0,this.showFooter=!1,this.showButtons=!1}render(){return u`
    ...
    `}render(){switch(this.imagePosition){case"full":return this._renderFull();case"right":return this._renderRight();case"bottom":return this._renderBottom();case"none":default:return this._renderNone()}}};Zt([b({type:String,reflect:!0})],Ct.prototype,"align",2);Zt([b({type:String,reflect:!0,attribute:"image-position"})],Ct.prototype,"imagePosition",2);Zt([b({type:Boolean,attribute:"show-eyebrow"})],Ct.prototype,"showEyebrow",2);Zt([b({type:Boolean,attribute:"show-secondary"})],Ct.prototype,"showSecondary",2);Zt([b({type:Boolean,attribute:"show-plain"})],Ct.prototype,"showPlain",2);Ct=Zt([W({tag:"june-look-at-me",styles:qo})],Ct);const Go='@charset "UTF-8";:host{display:block}.sat{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:var(--sp-10) var(--_section-px, var(--sp-10));gap:var(--sp-10);background:var(--card);color:var(--black)}.sat__header{display:flex;flex-direction:column;align-items:center;gap:var(--sp-4);width:940px;max-width:100%;text-align:center}.sat__header--left{align-items:flex-start;text-align:start;width:100%}.sat__feature{display:flex;gap:var(--sp-9);width:100%;align-items:flex-start}.sat__feature--right{flex-direction:row-reverse}.sat__text{flex:1 0 0;display:flex;flex-direction:column;align-items:flex-start;gap:var(--sp-6);min-width:0}.sat__icon{width:64px;height:64px;display:flex;align-items:center;justify-content:center;flex-shrink:0}.sat__icon ::slotted(*){width:64px;height:64px}.sat__info{display:flex;flex-direction:column;align-items:flex-start;gap:var(--sp-4);width:100%}.sat__cta{display:flex;gap:var(--sp-5);align-items:center}.sat__media{flex:1 0 0;display:flex;flex-direction:column;justify-content:center;gap:var(--sp-2);align-self:stretch;min-width:0}.sat__media-wrap{flex:1 0 0;position:relative;min-height:0;overflow:hidden}.sat__media-wrap ::slotted(img){position:absolute;top:0;right:0;bottom:0;left:0;width:100%;height:100%;display:block;object-fit:cover}.sat__footer{display:flex;align-items:center;justify-content:center}';var No=Object.defineProperty,Uo=Object.getOwnPropertyDescriptor,Aa=(a,t,e,d)=>{for(var o=d>1?void 0:d?Uo(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&No(t,e,o),o};let De=class extends J{constructor(){super(...arguments),this.textPosition="left",this.headerAlign="center"}render(){const a=this.textPosition==="right",t=this.headerAlign==="left";return u`
      <div class="sat">
      ...
      <div class=${this._rootClasses()}>
        ...
        ${this.error||this.forceState==="error"?u`
            <div class="jf__error" id=${this._errorId} role="alert" aria-live="assertive">
              <span class="jf__error-icon">${Zo}</span>
    ...
    `}_renderSelect(a,t){return u`
      ...
      <span class="jf__chevron">${td}</span>
    `}};B([b({type:String,reflect:!0})],C.prototype,"type",2);B([b({type:String})],C.prototype,"label",2);B([b({type:String})],C.prototype,"value",2);B([b({type:String})],C.prototype,"placeholder",2);B([b({type:String})],C.prototype,"hint",2);B([b({type:String})],C.prototype,"error",2);B([b({type:Boolean,reflect:!0})],C.prototype,"required",2);B([b({type:Boolean,reflect:!0})],C.prototype,"disabled",2);B([b({type:Boolean,reflect:!0})],C.prototype,"readonly",2);B([b({type:String})],C.prototype,"name",2);B([b({type:Array})],C.prototype,"options",2);B([b({type:Number})],C.prototype,"rows",2);B([b({type:Boolean,attribute:"show-required-text"})],C.prototype,"showRequiredText",2);B([b({type:String,attribute:"force-state",reflect:!0})],C.prototype,"forceState",2);B([b({type:String,attribute:"placeholder-select"})],C.prototype,"placeholderSelect",2);B([b({type:String,attribute:"required-text"})],C.prototype,"requiredText",2);B([b({type:String,attribute:"error-text"})],C.prototype,"errorText",2);C=B([W({tag:"june-field",styles:Ko})],C);const ed='@charset "UTF-8";:host{display:block}.lm{display:flex;align-items:center;gap:var(--sp-10);padding:var(--sp-10) var(--_section-px, var(--sp-10));background:var(--grey-50);color:var(--black)}.lm__text{flex:1 1 0%;display:flex;flex-direction:column;gap:var(--sp-6);min-width:0}.lm__cta{display:flex;gap:var(--sp-5);align-items:center;flex-shrink:0}@media(max-width:1024px){.lm{flex-direction:column;align-items:flex-start;gap:var(--sp-6);padding:var(--sp-9) var(--sp-8)}.lm__cta{gap:var(--sp-5)}}@media(max-width:640px){.lm{padding:var(--sp-8) var(--sp-5)}.lm__text{gap:var(--sp-5)}.lm__cta{flex-direction:column;align-items:flex-start;gap:var(--sp-4)}}';var ad=Object.getOwnPropertyDescriptor,sd=(a,t,e,d)=>{for(var o=d>1?void 0:d?ad(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=s(o)||o);return o};let Za=class extends J{render(){return u`
      <div class="lm">
        <div class="lm__text">
          <slot name="title"></slot>
          <slot name="body"></slot>
    ...
    `}};ts=rd([W({tag:"june-smiley-contact-box",styles:od})],ts);const Ds='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>',Sa='<svg width="6" height="9" viewBox="0 0 6 9" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 1 5 4.5 1 8"/></svg>',Ea='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',Ms='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',Rs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',Os='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',qs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>',Hs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',ct='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="16" height="11" rx="1.5"/><path d="M6 17h8M10 14v3"/></svg>',pt='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="12" height="16" rx="1.5"/><path d="M9 16h2"/></svg>',vt='<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="5.5" y="2" width="9" height="16" rx="1.5"/><path d="M9 16h2"/></svg>',id='<svg class="blk__card-arrow" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 12.5l9-9M5.5 3.5h7v7"/></svg>',x='<svg class="si" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',ld='<svg fill="none" viewBox="0 0 64 64"><path fill="var(--icon-accent)" d="M27.13 14.16a1.34 1.34 0 0 1 2.36 0l5.1 9.33q.2.34.54.54l9.33 5.1c.94.51.94 1.85 0 2.36l-9.33 5.1q-.35.2-.53.54l-5.11 9.33c-.51.94-1.85.94-2.36 0l-5.1-9.33q-.2-.35-.54-.53l-9.33-5.11a1.34 1.34 0 0 1 0-2.36l9.33-5.1q.34-.2.54-.54z"/><path fill="var(--icon-line)" d="M44.87 40.61a.38.38 0 0 1 .67 0L47 43.27q.06.1.16.15l2.65 1.45c.27.15.27.53 0 .67L47.15 47a.4.4 0 0 0-.16.16l-1.45 2.65a.38.38 0 0 1-.67 0l-1.45-2.65a.4.4 0 0 0-.15-.16l-2.66-1.45a.38.38 0 0 1 0-.67l2.66-1.45a.4.4 0 0 0 .15-.15z"/></svg>',nd='<svg fill="none" viewBox="0 0 64 64"><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M32.51 51.3a17.05 17.05 0 1 0 0-34.1 17.05 17.05 0 0 0 0 34.1Z"/><path fill="var(--icon-fill)" d="M32.51 25.35a8.17 8.17 0 1 0 0-16.35 8.17 8.17 0 0 0 0 16.35"/><path fill="var(--icon-accent)" d="M15.46 39.7a5.46 5.46 0 1 0 0-10.92 5.46 5.46 0 0 0 0 10.92"/><path fill="var(--icon-accent)" d="M49.42 39.66a5.46 5.46 0 1 0 0-10.93 5.46 5.46 0 0 0 0 10.93"/><path fill="var(--icon-line)" d="M32.51 55a3.7 3.7 0 1 0 0-7.4 3.7 3.7 0 0 0 0 7.4"/></svg>',cd='<svg fill="none" viewBox="0 0 64 64"><path fill="var(--icon-fill)" d="M60.4 24.16a15.16 15.16 0 1 0-15.2 15.16c2.47 0 4.78-.58 6.82-1.63l5.77 1.12c.22.04.43-.15.37-.37l-.94-5.09a15 15 0 0 0 3.13-9.19z"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M7.02 49.65q-.43 0-.88-.14A4.65 4.65 0 0 1 3 45.09V24.36a3.73 3.73 0 0 1 3.73-3.73h36.39a3.73 3.73 0 0 1 3.73 3.73v21.67a3.73 3.73 0 0 1-3.73 3.73H16.99L9.47 55v-5.33H7.04z"/><path fill="var(--icon-accent)" d="M11.53 32.14a3.99 3.99 0 1 0 0-7.98 3.99 3.99 0 0 0 0 7.98"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M7.54 38.8h23.25"/></svg>',pd='<svg fill="none" viewBox="-1 -1 66 66"><path fill="var(--icon-fill)" d="M15.62 53.07V25.75A15.8 15.8 0 0 1 31.37 10a15.8 15.8 0 0 1 15.75 15.75v27.32z"/><path fill="var(--icon-fill)" d="M15.66 24.66A15.8 15.8 0 0 1 31.37 10a15.8 15.8 0 0 1 15.67 14.14"/><path fill="var(--icon-bg)" d="M48.58 24.74H14.17a14.17 14.17 0 0 0 0 28.34h34.41a14.17 14.17 0 1 0 0-28.34Z"/><path fill="var(--icon-accent)" d="M47.96 54c8.35 0 15.11-6.78 15.11-15.15s-6.76-15.16-15.1-15.16A15.15 15.15 0 0 0 47.96 54"/><path fill="var(--icon-line)" d="M43.59 29.3a5.53 5.53 0 1 0-.02-11.05 5.53 5.53 0 0 0 .02 11.05"/><path fill="none" stroke="var(--icon-line)" stroke-miterlimit="10" d="M48.58 24.74H14.17a14.17 14.17 0 0 0 0 28.34h34.41a14.17 14.17 0 1 0 0-28.34Z"/></svg>',vd='<svg fill="none" viewBox="0 0 64 64"><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M56.65 9H6.35C5.6 9 5 9.74 5 10.66v9.68c0 .92.6 1.66 1.35 1.66h50.3c.75 0 1.35-.74 1.35-1.66v-9.68C58 9.74 57.4 9 56.65 9Z"/><path fill="var(--icon-line)" d="M12.14 17.1a1.85 1.85 0 1 0 0-3.69 1.85 1.85 0 0 0 0 3.7"/><path fill="var(--icon-fill)" d="M56.92 26H6.08c-.6 0-1.08.55-1.08 1.23v9.54c0 .68.48 1.23 1.08 1.23h50.84c.6 0 1.08-.55 1.08-1.23v-9.54c0-.68-.48-1.23-1.08-1.23"/><path fill="var(--icon-line)" d="M12.14 33.86a1.85 1.85 0 1 0 0-3.7 1.85 1.85 0 0 0 0 3.7"/><path fill="var(--icon-accent)" d="M56.92 42H6.08c-.6 0-1.08.6-1.08 1.33v10.34C5 54.4 5.48 55 6.08 55h50.84c.6 0 1.08-.6 1.08-1.33V43.33c0-.73-.48-1.33-1.08-1.33"/><path fill="var(--icon-line)" d="M12.14 50.59a1.85 1.85 0 1 0 0-3.7 1.85 1.85 0 0 0 0 3.7"/></svg>',hd='<svg fill="none" viewBox="0 0 64 64"><path fill="var(--icon-line)" d="m33.76 41.81 5.91-16.45h1.7l5.91 16.45H46l-1.81-5.04h-7.4l-1.8 5.04zm6.72-15.39-3.34 9.32h6.67zM53.13 42c-2.37 0-4.07-1.15-4.07-3.42 0-2.79 2.67-3.64 5.64-3.64h2.5v-1.08c0-2.25-.92-3.22-3.03-3.22-1.82 0-3.1.78-3.38 2.56h-1.2c.28-2.53 2.35-3.6 4.62-3.6 2.51 0 4.21 1.2 4.21 4.26v7.96H57.2v-1.84c-.76 1.17-2.04 2.02-4.07 2.02m.1-.98c2.2 0 3.97-1.3 3.97-3.09v-2.04h-2.46c-2.5 0-4.46.52-4.46 2.69 0 1.54.97 2.44 2.94 2.44"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M27.88 14H6.43c-1.24 0-2.24 1-2.24 2.24v21.92c0 1.24 1 2.24 2.24 2.24h21.45c1.24 0 2.24-1 2.24-2.24V16.24c0-1.24-1-2.24-2.24-2.24Z"/><path fill="var(--icon-accent)" d="m23.22 27.19-6.06-6.07-6.07 6.07 6.07 6.07z"/><path fill="var(--icon-accent)" d="M58.34 14h-4.15c-.3 0-.53.24-.53.53v4.15c0 .3.24.53.53.53h4.15c.3 0 .53-.24.53-.53v-4.15c0-.3-.24-.53-.53-.53"/><path stroke="var(--icon-fill)" stroke-miterlimit="10" stroke-width=".5" d="m57.28 16.22-1.01 1.02-1.02-1.02"/><path fill="var(--icon-line)" d="m29.53 49.78-4.54-13.1c-.07-.22.14-.42.35-.32l12.15 5.42c.23.1.19.45-.06.5l-6 1.09a.3.3 0 0 0-.21.21l-1.19 6.17c-.05.26-.42.29-.5.04z"/></svg>',bd='<svg fill="none" viewBox="0 0 64 64"><path fill="var(--icon-fill)" d="M27.22 9.13H4v37.66h23.22z"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M58.74 9.5v37.03H36.5V9.5z"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M11.1 32.63V55h41.3v-7.95"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M51.96 21.1v15.3h-24.7"/><path fill="var(--icon-line)" d="M11.15 35.2a2.57 2.57 0 1 0 0-5.14 2.57 2.57 0 0 0 0 5.14"/><path fill="var(--icon-accent)" d="M51.95 23.56a3.1 3.1 0 1 0 0-6.18 3.1 3.1 0 0 0 0 6.18"/></svg>',ud='<svg fill="none" viewBox="0 0 64 64"><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M39.5 26.43V10h15.6"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M59.85 30.25 39.5 10"/><path fill="var(--icon-line)" d="M59.4 36.48H39.8V55h19.6z"/><path fill="var(--icon-fill)" d="M31.93 28.2H4v26.78h27.93z"/><path fill="var(--icon-accent)" d="M31.93 9H4v13.69h27.93z"/></svg>',gd='<svg fill="none" viewBox="0 0 64 64"><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M32 55a23 23 0 1 0 0-46 23 23 0 0 0 0 46Z"/><path fill="var(--icon-accent)" d="M23.7 33.88v-8.4l8.1-3.84 8.52 3.84v8.4c-2.06 7.3-8.3 8.48-8.3 8.48-7.5-2.28-8.3-8.48-8.3-8.48z"/><path stroke="var(--icon-fill)" stroke-miterlimit="10" d="m34.97 29.2-4.1 3.97L29 31.2"/></svg>',md='<svg fill="none" viewBox="0 0 64 64"><path fill="var(--icon-fill)" d="M31.69 31.58a4.5 4.5 0 1 0-8.98 0 4.5 4.5 0 0 0 8.98 0"/><path fill="var(--icon-fill)" d="M17.35 49.03a9.85 9.85 0 0 1 19.68 0"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M51.12 14.88H3.27c-.7 0-1.27.57-1.27 1.27v37.58c0 .7.57 1.27 1.27 1.27h47.85c.7 0 1.27-.57 1.27-1.27V16.15c0-.7-.57-1.27-1.27-1.27Z"/><path stroke="var(--icon-line)" stroke-miterlimit="10" d="M52.4 20.58H2"/><path fill="var(--icon-fill)" stroke="var(--icon-accent)" stroke-miterlimit="10" d="M50.67 32.16a11.58 11.58 0 1 0 0-23.16 11.58 11.58 0 0 0 0 23.16Z"/><path fill="var(--icon-accent)" d="m48.29 16.08 6.84 4.4-6.86 4.6z"/></svg>',ye=["ai","api","chatbot","cloud","data","design-system","patterns","scalability","security","webinar"],ja={ai:ld,api:nd,chatbot:cd,cloud:pd,data:vd,"design-system":hd,patterns:bd,scalability:ud,security:gd,webinar:md},Ke='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>';function i(a,t){return`<span class="snip" data-copy-token="${t}"><span class="snip__val">${a}</span><button class="snip__btn" aria-label="Copy ${t}">${Ke}</button></span>`}function p(a){return`<span class="snip" data-copy-color="${a}"><span class="snip__val">${a}</span><button class="snip__btn" aria-label="Copy ${a}">${Ke}</button></span>`}function S(a){navigator.clipboard.writeText(a).catch(()=>{})}let es=0;function j(a){const t=document.getElementById("copy-toast");t&&(t.innerHTML=a,t.classList.add("show"),clearTimeout(es),es=window.setTimeout(()=>t.classList.remove("show"),1500))}function yd(){let a=document.querySelector(".snip-live-region");a||(a=document.createElement("div"),a.setAttribute("aria-live","polite"),a.setAttribute("aria-atomic","true"),a.className="sr-only snip-live-region",document.body.appendChild(a)),document.querySelectorAll(".snip").forEach(t=>{const e=t,d=e.dataset.copyToken||e.dataset.copyColor;if(!d)return;e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-label",`Copy ${d}`);const o=async()=>{try{await S(d),e.classList.add("copied"),setTimeout(()=>e.classList.remove("copied"),1500),a&&(a.textContent=`Copied ${d}`,setTimeout(()=>a.textContent="",2e3))}catch(r){console.error("Copy failed:",r),a&&(a.textContent="Copy failed")}};e.addEventListener("click",o),e.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),o())})})}function ht(a){return"/june/dist"+(a.startsWith("/")?a.slice(1):a)}function D(a,t){const e=Array.from(a.querySelectorAll("button"));function d(o){e.forEach(r=>{r.classList.remove("on"),r.setAttribute("aria-checked","false"),r.setAttribute("tabindex","-1")}),o.classList.add("on"),o.setAttribute("aria-checked","true"),o.setAttribute("tabindex","0"),t&&t(o)}e.forEach((o,r)=>{o.addEventListener("click",()=>d(o)),o.addEventListener("keydown",s=>{let l=-1;s.key==="ArrowRight"||s.key==="ArrowDown"?(s.preventDefault(),l=(r+1)%e.length):(s.key==="ArrowLeft"||s.key==="ArrowUp")&&(s.preventDefault(),l=(r-1+e.length)%e.length),l>=0&&(e[l].focus(),d(e[l]))})}),e.forEach(o=>{o.setAttribute("tabindex",o.classList.contains("on")?"0":"-1")})}function _d(){document.querySelectorAll(".tok:not([tabindex])").forEach(a=>{a.setAttribute("tabindex","0"),a.setAttribute("role","button"),a.addEventListener("keydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),a.click())})})}function fd(){document.querySelectorAll(".sw:not([data-sw-ready])").forEach(a=>{var d,o;a.setAttribute("data-sw-ready","");const e=(o=(d=(a.getAttribute("style")||"").match(/background:\s*([^;\"]+)/))==null?void 0:d[1])==null?void 0:o.trim();e&&(a.setAttribute("role","button"),a.setAttribute("tabindex","0"),a.style.cursor="pointer",a.title=`Copy ${e}`,a.addEventListener("click",()=>{as(e)}),a.addEventListener("keydown",r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),as(e))}))})}function as(a){S(a),j("Copied!")}var kd=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,Fa=(a,t,e,d)=>{for(var o=d>1?void 0:d?xd(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&kd(t,e,o),o};const zs=[{id:"start",label:"Get started",icon:ft`<svg class="sidebar__section-ico" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8h12M8 2l6 6-6 6"/></svg>`,items:[{page:"getting-started",label:"Introduction"},{page:"tokens-export",label:"Tokens export"}]},{id:"foundations",label:"Foundations",icon:ft`<svg class="sidebar__section-ico" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M1.5 8s2.8-4.5 6.5-4.5S14.5 8 14.5 8s-2.8 4.5-6.5 4.5S1.5 8 1.5 8z"/><circle cx="8" cy="8" r="2"/></svg>`,items:[{page:"typography",label:"Typography"},{page:"spacing",label:"Spacing"},{page:"colors",label:"Colors"},{page:"shadows",label:"Shadows"},{page:"breakpoints",label:"Breakpoints"},{page:"illustrations",label:"Illustrations"}]},{id:"components",label:"Components",icon:ft`<svg class="sidebar__section-ico" viewBox="-0.5 -0.5 17 17" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="1" width="6" height="6" rx="1"/><rect x="9" y="1" width="6" height="6" rx="1"/><rect x="1" y="9" width="6" height="6" rx="1"/><rect x="9" y="9" width="6" height="6" rx="1"/></svg>`,items:[{page:"button",label:"Button"},{page:"eyebrow",label:"Eyebrow"},{page:"field",label:"Field"}]},{id:"stencils",label:"Stencils",icon:ft`<svg class="sidebar__section-ico" viewBox="-0.5 -0.5 17 17" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="1" width="14" height="6" rx="1"/><rect x="1" y="9" width="14" height="6" rx="1"/></svg>`,items:[{page:"look-at-me",label:"Look at Me"},{page:"show-and-tell",label:"Show and Tell"},{page:"island",label:"Island"},{page:"blocks",label:"Blocks"},{page:"smiley-contact-box",label:"Smiley Contact Box"},{page:"learn-more",label:"Learn More"},{page:"card-row",label:"Card Row"},{page:"deep-dive",label:"Deep Dive",badge:"new"}]}],Gs={};zs.forEach(a=>a.items.forEach(t=>{Gs[t.page]=a.label}));let Me=class extends M{constructor(){super(...arguments),this._activePage="getting-started",this._collapsed=new Set}createRenderRoot(){return this}setActive(a){this._activePage=a,this.requestUpdate()}_toggleSection(a){if(document.body.classList.contains("sidebar-collapsed")){document.body.classList.remove("sidebar-collapsed");return}this._collapsed.has(a)?this._collapsed.delete(a):this._collapsed.add(a),this.requestUpdate()}_navigate(a){this._activePage=a,this.dispatchEvent(new CustomEvent("navigate",{detail:a,bubbles:!0,composed:!0})),window.matchMedia("(max-width: 700px)").matches&&document.body.classList.add("sidebar-collapsed")}render(){return u`
      <aside class="sidebar" role="navigation" aria-label="Design system navigation">
        ...
        <nav class="sidebar__nav" id="sidebarNav" @keydown=${this._onNavKeydown}>
          ${zs.map(a=>this._renderSection(a))}
        </nav>
    ...
    `}_onCollapse(){const a=document.body.classList.toggle("sidebar-collapsed"),t=this.querySelector("#sidebarCollapse");t&&(t.setAttribute("aria-expanded",String(!a)),t.setAttribute("aria-label",a?"Expand sidebar":"Collapse sidebar"))}_onNavKeydown(a){const t=[...this.querySelectorAll(".sidebar__item")],e=t.indexOf(document.activeElement);e!==-1&&(a.key==="ArrowDown"?(a.preventDefault(),t[(e+1)%t.length].focus()):a.key==="ArrowUp"?(a.preventDefault(),t[(e-1+t.length)%t.length].focus()):(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),t[e].click()))}};Fa([Z()],Me.prototype,"_activePage",2);Fa([Z()],Me.prototype,"_collapsed",2);Me=Fa([Q("sidebar-nav")],Me);var wd=Object.defineProperty,$d=Object.getOwnPropertyDescriptor,Ns=(a,t,e,d)=>{for(var o=d>1?void 0:d?$d(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&wd(t,e,o),o};let na=class extends M{constructor(){super(...arguments),this._dark=!1,this._prefersDark=window.matchMedia("(prefers-color-scheme: dark)"),this._onSchemeChange=a=>{localStorage.getItem("june-dm")===null&&(this._dark=a.matches,this._apply())}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback();const a=localStorage.getItem("june-dm");a!==null?this._dark=a==="1":this._dark=this._prefersDark.matches,this._apply(),this._prefersDark.addEventListener("change",this._onSchemeChange)}disconnectedCallback(){super.disconnectedCallback(),this._prefersDark.removeEventListener("change",this._onSchemeChange)}_apply(){document.body.classList.toggle("dm",this._dark)}_toggle(){this._dark=!this._dark,this._apply(),localStorage.setItem("june-dm",this._dark?"1":"0")}render(){return u`
    ...
    `}};Ns([Z()],na.prototype,"_dark",2);na=Ns([Q("dark-mode-toggle")],na);var Ad=Object.getOwnPropertyDescriptor,Sd=(a,t,e,d)=>{for(var o=d>1?void 0:d?Ad(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=s(o)||o);return o};let ss=class extends M{createRenderRoot(){return this}render(){return u`<div class="copy-toast" id="copy-toast" role="status" aria-live="polite"></div>`}};ss=Sd([Q("copy-toast")],ss);var Ed=Object.defineProperty,jd=Object.getOwnPropertyDescriptor,Us=(a,t,e,d)=>{for(var o=d>1?void 0:d?jd(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Ed(t,e,o),o};function Fd(){return ht("/topbar-icon.png")}let ca=class extends M{constructor(){super(...arguments),this._currentPage="getting-started",this._handleResize=()=>{window.innerWidth<=700&&document.body.classList.add("sidebar-collapsed")},this._handleBackdropClick=a=>{if(window.matchMedia("(max-width: 500px)").matches&&!document.body.classList.contains("sidebar-collapsed")){const t=this.querySelector(".sidebar"),e=this.querySelector("#sidebarOpen");t&&!t.contains(a.target)&&e&&!e.contains(a.target)&&document.body.classList.add("sidebar-collapsed")}}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),window.innerWidth<=700&&document.body.classList.add("sidebar-collapsed"),window.addEventListener("resize",this._handleResize),document.addEventListener("click",this._handleBackdropClick)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._handleResize),document.removeEventListener("click",this._handleBackdropClick)}_onNavigate(a){this._currentPage=a.detail,this.dispatchEvent(new CustomEvent("page-change",{detail:a.detail,bubbles:!0}))}_openSidebar(){document.body.classList.remove("sidebar-collapsed")}render(){return u`
      ...
      <div class="layout">
        <header class="topbar" role="banner" aria-label="June DS">
          <div class="topbar__left">
            ...
            <img class="topbar__ico" src=${Fd()} alt="June DS" />
    ...
    `}firstUpdated(){const a=this.querySelector(".content"),t=this.querySelector("#scrollTop");a&&t&&a.addEventListener("scroll",()=>{t.classList.toggle("visible",a.scrollTop>300)})}_scrollTop(){const a=this.querySelector(".content");a&&a.scrollTo({top:0,behavior:"smooth"})}get currentPage(){return this._currentPage}set currentPage(a){this._currentPage=a;const t=this.querySelector("sidebar-nav");t&&t.setActive(a);const e=this.querySelector(".content__inner");e&&e.setAttribute("data-page-id",a)}};Us([Z()],ca.prototype,"_currentPage",2);ca=Us([Q("app-shell")],ca);var Cd=Object.defineProperty,Bd=Object.getOwnPropertyDescriptor,Ye=(a,t,e,d)=>{for(var o=d>1?void 0:d?Bd(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Cd(t,e,o),o};const os=[{id:"gx",label:"GeneXus",color:"var(--gx)"},{id:"nx",label:"Next",color:"var(--nx)"},{id:"ge",label:"GEAI",color:"var(--ge)"}];let _e=class extends M{constructor(){super(...arguments),this._brand="gx",this._open=!1,this._visible=!0,this._onBrandAwareChange=a=>{this._visible=a.detail,this._visible||(this._open=!1)},this._onDocClick=a=>{this.contains(a.target)||(this._open=!1)}}createRenderRoot(){return this}_select(a){var t;this._brand=a,this._open=!1,this.dispatchEvent(new CustomEvent("brand-change",{detail:a,bubbles:!0,composed:!0})),(t=this.querySelector(".brand-chip__trigger"))==null||t.focus()}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick),document.addEventListener("brand-aware-change",this._onBrandAwareChange)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick),document.removeEventListener("brand-aware-change",this._onBrandAwareChange)}_focusSelected(){this._open&&this.updateComplete.then(()=>{const a=this.querySelector(".brand-chip__opt.on");a==null||a.focus()})}_onTriggerKeydown(a){(a.key==="ArrowDown"||a.key==="ArrowUp")&&(a.preventDefault(),this._open=!0,this.updateComplete.then(()=>{var o;const t=[...this.querySelectorAll(".brand-chip__opt")],e=t.findIndex(r=>r.classList.contains("on")),d=a.key==="ArrowDown"?Math.min(e+1,t.length-1):Math.max(e-1,0);(o=t[d])==null||o.focus()}))}_onMenuKeydown(a){var d,o,r,s,l;const t=[...this.querySelectorAll(".brand-chip__opt")],e=t.indexOf(document.activeElement);e!==-1&&(a.key==="ArrowDown"?(a.preventDefault(),(d=t[Math.min(e+1,t.length-1)])==null||d.focus()):a.key==="ArrowUp"?(a.preventDefault(),(o=t[Math.max(e-1,0)])==null||o.focus()):a.key==="Home"?(a.preventDefault(),(r=t[0])==null||r.focus()):a.key==="End"?(a.preventDefault(),(s=t[t.length-1])==null||s.focus()):a.key==="Escape"&&(a.preventDefault(),this._open=!1,(l=this.querySelector(".brand-chip__trigger"))==null||l.focus()))}render(){if(!this._visible)return u``;const a=os.find(t=>t.id===this._brand);return u`
    ...
    `}};Ye([Z()],_e.prototype,"_brand",2);Ye([Z()],_e.prototype,"_open",2);Ye([Z()],_e.prototype,"_visible",2);_e=Ye([Q("brand-switcher")],_e);var Id=Object.defineProperty,Td=Object.getOwnPropertyDescriptor,Xe=(a,t,e,d)=>{for(var o=d>1?void 0:d?Td(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Id(t,e,o),o};let fe=class extends M{constructor(){super(...arguments),this.tabs=[],this.label="Sections",this._active=0}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this._restoreActiveTab()}_restoreActiveTab(){var e;const a=window.location.hash.slice(1);if(!a)return;const t=(e=document.querySelector("#page"))==null?void 0:e.getAttribute("data-page-id");if(t&&a.startsWith(t+"-")){const d=a.slice(t.length+1),o=this.tabs.findIndex(r=>r.toLowerCase().replace(/\s+/g,"-").replace(/&/g,"")===d);o>=0&&(this._active=o)}}_select(a){var e;this._active=a,this.dispatchEvent(new CustomEvent("tab-change",{detail:a,bubbles:!0}));const t=(e=document.querySelector("#page"))==null?void 0:e.getAttribute("data-page-id");if(t&&this.tabs[a]){const d=this.tabs[a].toLowerCase().replace(/\s+/g,"-").replace(/&/g,"");window.history.replaceState(null,"",`#${t}-${d}`)}}_onKeydown(a,t){var d;let e=-1;a.key==="ArrowRight"?e=(t+1)%this.tabs.length:a.key==="ArrowLeft"?e=(t-1+this.tabs.length)%this.tabs.length:a.key==="Home"?e=0:a.key==="End"&&(e=this.tabs.length-1),e>=0&&(a.preventDefault(),this._select(e),(d=this.querySelectorAll(".tabs button")[e])==null||d.focus())}render(){return u`
      ...
      `)}
    `}};Xe([b({type:Array})],fe.prototype,"tabs",2);Xe([b({type:String})],fe.prototype,"label",2);Xe([Z()],fe.prototype,"_active",2);fe=Xe([Q("tab-panel")],fe);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class pa extends $o{constructor(t){if(super(t),this.it=g,t.type!==xo.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||t==null)return this._t=void 0,this.it=t;if(t===jt)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}pa.directiveName="unsafeHTML",pa.resultType=1;const Ld=wo(pa);function R(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(&lt;\/?)([\w-]+)/g,'$1<span class="ck">$2</span>').replace(/\s([\w-]+)=/g,' <span class="cv">$1</span>=').replace(/"([^"]*)"/g,'"<span class="cs">$1</span>"').replace(/(&lt;!--.*?--&gt;)/g,'<span class="cc">$1</span>')}var Pd=Object.defineProperty,Dd=Object.getOwnPropertyDescriptor,Ca=(a,t,e,d)=>{for(var o=d>1?void 0:d?Dd(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Pd(t,e,o),o};let Re=class extends M{constructor(){super(...arguments),this.code="",this.label="HTML"}createRenderRoot(){return this}_copy(){S(this.code),j("Copied!")}render(){return u`
      <div class="code-snippet">
        ...
        <pre class="code-snippet__pre">${Ld(R(this.code))}</pre>
      </div>
    `}};Ca([b()],Re.prototype,"code",2);Ca([b()],Re.prototype,"label",2);Re=Ca([Q("code-snippet")],Re);var Md=Object.defineProperty,Rd=Object.getOwnPropertyDescriptor,Ba=(a,t,e,d)=>{for(var o=d>1?void 0:d?Rd(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Md(t,e,o),o};let Oe=class extends M{constructor(){super(...arguments),this.value="",this.isStatic=!1}createRenderRoot(){return this}_copy(){this.isStatic||(S(this.value),j(`Copied ${this.value}`))}render(){return u`
      <span
      ...
      >${this.value}</span>
    `}};Ba([b()],Oe.prototype,"value",2);Ba([b({type:Boolean,attribute:"static"})],Oe.prototype,"isStatic",2);Oe=Ba([Q("token-pill")],Oe);var Od=Object.getOwnPropertyDescriptor,qd=(a,t,e,d)=>{for(var o=d>1?void 0:d?Od(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=s(o)||o);return o};let ds=class extends M{createRenderRoot(){return this}render(){return u`
      <div class="pg-controls">
        <slot></slot>
      </div>
    `}};ds=qd([Q("playground-controls")],ds);function Hd(){return ht("/hero-logo.png")}const zd=`
<style>
...
<div class="landing">
  <img class="landing__hero" src="${Hd()}" alt="June DS" />
...
`,Gd={title:"Getting Started",desc:"",tabs:["Overview"],content:[zd],hideHeader:!0},Nd=`
<style>
...
`;function Ud(){var a;(a=document.getElementById("page"))==null||a.addEventListener("click",t=>{const e=t.target.closest("[data-action]");e&&e.dataset.action==="copy-root-tokens"&&window._juneCopyRootTokens()})}const Vd={title:"Tokens export",desc:"Take the system with you. CSS custom properties, JSON — pick your format.",tabs:["Export"],content:[Nd],init:Ud},Wd=`
...
`,Xd={title:"Typography",desc:"Graphik grabs attention, Rubik keeps you reading. One scale, two families, role-based naming.",tabs:["Type scale","Tokens"],content:[Kd,Yd]},rs=[["none",0,"Explicit zero spacing, reset gaps"],["0",2,"Sub-grid gap, hairline dividers"],["1",4,"Icon-to-text spacing, minimum internal gap"],["2",8,"Badge/chip inner padding, compact list gaps"],["3",12,"Input padding, form element gaps"],["4",16,"Card padding, list item gaps, small section margins"],["5",24,"Container padding, content group gaps"],["6",32,"Section margins, modal padding"],["7",48,"Main page block separation"],["8",64,"Hero padding, major section separation"],["9",80,"Full-width section breathing room"],["10",128,"Large hero vertical padding"],["11",172,"Section horizontal padding (desktop)"],["12",240,"Maximum horizontal breathing room"]],Qd=[["0",2,2,null,2,null],["1",4,4,null,4,null],["2",8,8,null,8,null],["3",12,12,null,12,null],["4",16,16,null,16,null],["5",24,24,null,16,"--sp-4"],["6",32,24,"--sp-5",16,"--sp-4"],["7",48,32,"--sp-6",24,"--sp-5"],["8",64,32,"--sp-6",24,"--sp-5"],["9",80,48,"--sp-7",24,"--sp-5"],["10",128,64,"--sp-8",24,"--sp-5"],["11",172,64,"--sp-8",24,"--sp-5"],["12",240,80,"--sp-9",32,"--sp-6"]],Zd=[["0",2,2,null,2,null],["1",4,4,null,4,null],["2",8,8,null,8,null],["3",12,12,null,12,null],["4",16,16,null,8,"--sp-2"],["5",24,24,null,16,"--sp-4"],["6",32,32,null,24,"--sp-5"],["7",48,48,null,32,"--sp-6"],["8",64,48,"--sp-7",32,"--sp-6"],["9",80,64,"--sp-8",48,"--sp-7"],["10",128,80,"--sp-9",64,"--sp-8"]];function is(a,t){return t?`${a}px ${i(t,t)}`:`${a}px`}function tr(a){const[t,e,d,o,r,s]=a;return`<tr${!o&&!s?' style="color:var(--grey-400)"':""}><td>${i(`--sp-${t}`,`--sp-${t}`)}</td><td>${e}px</td><td>${is(d,o)}</td><td>${is(r,s)}</td></tr>`}function ls(a,t){return`<div class="vcard">
...
${rs.map(([a,t])=>`      <div style="display:flex;align-items:center;gap:16px">
...
<div class="vcard">
  ...
  <div class="vcard__body" style="padding:0">
    <table class="tok-table">
      ...
      <tbody>
${rs.map(([a,t,e])=>`        <tr><td>${i(`--sp-${a}`,`--sp-${a}`)}</td><td>${t}px</td><td>${e}</td></tr>`).join(`
`)}
      </tbody>
    </table>
  </div>
...
`,ar=`
${ls("Horizontal spacing",Qd)}

${ls("Vertical spacing",Zd)}
...
`;function sa(a,t){const e=rr(a)?"border:1px solid #e0e0e0;":"";return`<span class="sw" style="background:${a};${e}"></span><span class="snip" data-copy-color="${a}"><span class="snip__val">${a}</span><button class="snip__btn" aria-label="Copy ${a}">${Ke}</button></span>`}function P(a,t,e,d,o){return`<tr><td><span class="snip" data-copy-token="${a}"><span class="snip__val">${a}</span><button class="snip__btn" aria-label="Copy var(--${a})">${Ke}</button></span></td><td class="sem-info">${o||""}</td><td>${sa(t[0],t[1])}</td><td>${sa(e[0],e[1])}</td><td>${sa(d[0],d[1])}</td></tr>`}function w(a,t,e,d){return P(a,[t,e],[t,e],[t,e],d)}function Rt(a,t){return`<div class="vcard"><div class="vcard__head"><span class="vcard__name">${a}</span></div><div class="vcard__body" style="padding:0"><table class="tok-table sem-table"><thead><tr><th>Token</th><th>Info</th><th><span class="sem-dot" style="background:var(--gx)"></span>GeneXus</th><th><span class="sem-dot" style="background:var(--nx)"></span>Next</th><th><span class="sem-dot" style="background:var(--ge)"></span>GEAI</th></tr></thead><tbody>
${t}
</tbody></table></div></div>`}const nr=`
<style>
...
${P("june-action__primary--hover",Mt(y.gx),Mt(y.nx),Mt(y.ge))}
...
${P("june-icon__primary--hover",Mt(y.gx),Mt(y.nx),Mt(y.ge))}
...
`)}
`;function cr(){var a;(a=document.getElementById("page"))==null||a.addEventListener("click",t=>{const e=t.target.closest(".swatch__copy[data-copy-color]");e&&(S(e.dataset.copyColor),j("Copied "+e.dataset.copyColor))})}const pr={title:"Colors",desc:"Three brands, one palette. Semantic tokens that shift identity without losing harmony.",tabs:["Primitives","Semantic"],content:[lr,nr],init:cr},vr=`
<style>
...
`,br={title:"Shadows",desc:"Six levels of depth that tell the eye where to look.",tabs:["Elevation","Tokens"],content:[vr,hr]},ur=`
<style>
...
`,gr=[["xxs","--bp-desktop-xs",380],["xs","--bp-desktop-s",440],["s","--bp-desktop-m",512],["m","--bp-desktop-l",640],["l","--bp-desktop-xl",760],["xl","--bp-desktop-2xl",940],["xxl","--bp-desktop-3xl",1440]],mr=`
<div class="vcard" style="margin-bottom:var(--sp-5)">
  ...
  <div class="vcard__body" style="padding:0">
    <table class="tok-table">
      ...
      <tbody>
${gr.map(([a,t,e])=>`        <tr><td><code class="tok tok--static">${a}</code></td><td>${i(t,t)}</td><td>${e}px</td></tr>`).join(`
`)}
      </tbody>
    </table>
  </div>
...
`;function yr(){var a;(a=document.getElementById("page"))==null||a.addEventListener("click",t=>{const e=t.target.closest("[data-copy-snippet]");if(e){const d=e.dataset.copySnippet,o=d?document.getElementById(d):null;o&&(S(o.textContent||""),j("Copied!"))}})}const _r={title:"Breakpoints",desc:"Where layouts adapt. From phone to widescreen, nothing breaks.",tabs:["Viewport","Content widths"],content:[ur,mr],init:yr},k=a=>a.replace("<svg",'<svg slot="icon"'),fr=`
...
<div style="margin-top:var(--sp-5);">
  <div class="matrix">
    ...
    <div class="matrix__grid" id="btn-focus-body">
      ...
      <div class="matrix__cell"><june-button variant="icon" icon-only label="Star">${k(Ea)}</june-button></div>
    </div>
    </div>
  </div>
</div>
...
`,xr={title:"Button",desc:"The hardest-working element in the UI. Six variants, every brand, always accessible.",tabs:["Preview","Specs"],content:[fr,kr],brandAware:!0},wr=`
<div class="pg-controls">
...
`;function oa(){const a=document.getElementById("eb-icon"),t=document.getElementById("eb-tag"),e=document.getElementById("eb-cta"),d=document.getElementById("eb-tag-text"),o=document.getElementById("eb-text"),r=document.getElementById("eb-cta-text");if(!a||!t||!e||!d||!o||!r)return;const s=a.checked,l=t.checked,n=e.checked,c=d.value||"New",h=o.value||"Announcement text",v=r.value||"Read more",m=["lam-eyebrow"];s||m.push("lam-eyebrow--no-icon");let $='<div class="'+m.join(" ")+'" role="status">';s&&($+='<span class="lam-eyebrow__icon" aria-hidden="true">'+Ds+"</span>"),l&&($+='<span class="lam-eyebrow__tag">'+c+"</span>"),$+='<div class="lam-eyebrow__body">',$+='<span class="lam-eyebrow__text">'+h+"</span>",n&&($+='<span class="lam-eyebrow__dash" aria-hidden="true">—</span>',$+='<a class="lam-eyebrow__cta" href="#">'+v+' <span aria-hidden="true">'+Sa+"</span></a>"),$+="</div></div>";const F=document.getElementById("eb-preview");F&&(F.innerHTML=$);let E='<div class="'+m.join(" ")+`">
...
`),E+=`  </div>
</div>`;const q=document.getElementById("eb-code");q&&(q.innerHTML=R(E))}const Ar={title:"Eyebrow",desc:"The quiet attention-grabber. An inline banner with icon, tag, and call to action.",tabs:["Preview","Specs"],content:[wr,$r],init(){["eb-icon","eb-tag","eb-cta"].forEach(d=>{const o=document.getElementById(d);o&&o.addEventListener("change",oa)}),["eb-tag-text","eb-text","eb-cta-text"].forEach(d=>{const o=document.getElementById(d);o&&o.addEventListener("input",oa)});const e=document.getElementById("eb-copy-btn");e&&e.addEventListener("click",()=>{const d=document.getElementById("eb-code");d&&(S(d.textContent||""),j("Copied!"))}),oa()}};function gt(a,t,e,d="none",o=0){let r="blk__card",s="";return d==="accent"?(r+=" blk__card--accent",s=' style="--_accent:'+He[o%He.length]+'"'):d==="outlined"&&(r+=" blk__card--outlined"),'<div class="'+r+'"'+s+'><div class="blk__card-top">'+('<div class="blk__card-icon">'+a+"</div>")+'<div class="blk__card-title">'+t+'</div></div><div class="blk__card-body">'+e+'</div><a class="blk__card-link" href="#">Link '+id+"</a></div>"}const Ot=[gt(Ms,"AI-Powered Development","Build intelligent applications with integrated AI agents that understand your business logic and automate complex workflows."),gt(Os,"Low-Code Platform","Create enterprise applications visually with a powerful low-code environment that generates native, optimized code."),gt(Rs,"Enterprise Security","Built-in security features including role-based access control, data encryption, and compliance certifications."),gt(Hs,"Multi-Platform Deploy","Deploy once, run anywhere. Generate native apps for web, mobile, and desktop from a single knowledge base."),gt(qs,"Scalable Architecture","Start small and grow. Our architecture scales seamlessly from prototype to millions of users."),gt(Ea,"Developer Experience","Intuitive tools, comprehensive documentation, and a vibrant community to accelerate your development.")],Ce=[{icon:Ms,title:"AI-Powered Development",body:"Build intelligent applications with integrated AI agents that understand your business logic and automate complex workflows."},{icon:Os,title:"Low-Code Platform",body:"Create enterprise applications visually with a powerful low-code environment that generates native, optimized code."},{icon:Rs,title:"Enterprise Security",body:"Built-in security features including role-based access control, data encryption, and compliance certifications."},{icon:Hs,title:"Multi-Platform Deploy",body:"Deploy once, run anywhere. Generate native apps for web, mobile, and desktop from a single knowledge base."},{icon:qs,title:"Scalable Architecture",body:"Start small and grow. Our architecture scales seamlessly from prototype to millions of users."},{icon:Ea,title:"Developer Experience",body:"Intuitive tools, comprehensive documentation, and a vibrant community to accelerate your development."}];function da(a){const t=Ce[a];return gt(t.icon,t.title,t.body,Ut,a)}let Kt="top",qe="left",Bt=2,Ia=1440,Ut="none";const He=["#34C759","#00BCD4","#5BA7FF","#FF9500","#AF52DE","#30D5C8"];function Sr(){const a=Ia<=1023,e=a||Bt===3;[document.getElementById("blk-align-sep"),document.getElementById("blk-align-label"),document.getElementById("blk-align-pills")].forEach(d=>{d&&(d.style.display=e?"none":"")}),e&&Kt==="left"&&(Kt="top",document.querySelectorAll("#blk-align-pills button").forEach(d=>d.classList.toggle("on",d.dataset.val==="top"))),[document.getElementById("blk-cols-sep"),document.getElementById("blk-cols-label"),document.getElementById("blk-cols-pills")].forEach(d=>{d&&(d.style.display=a?"none":"")}),a&&(Bt=2,document.querySelectorAll("#blk-cols-pills button").forEach(d=>d.classList.toggle("on",d.dataset.val==="2")))}function ns(a,t){Ia=a;let e;if(a<=639?e="mobile":a<=1023?e="tablet":e="desktop",t){const s=t.closest(".lam-device-bar");s&&s.querySelectorAll(".lam-device").forEach(l=>l.classList.remove("on")),t.classList.add("on")}const d=document.getElementById("blk-viewport");if(d){d.setAttribute("data-bp",e),e==="desktop"&&a>=940?(d.style.width="100%",d.style.maxWidth="none",d.style.margin="0"):(d.style.width=a+"px",d.style.maxWidth="100%",d.style.margin="0 auto");const s=document.getElementById("blk-breakout");s&&(s.style.padding=e==="desktop"&&a>=940?"0":"24px")}const o=e.charAt(0).toUpperCase()+e.slice(1),r=document.getElementById("blk-width-label");r&&(r.textContent=o+" · "+a+"px"),mt()}function Er(a,t){const e=document.getElementById("blk-code");if(!e)return;const d=Bt===3,o=Kt==="left"&&!d,r=qe==="center";let s='<div class="blk'+(o?" blk--left":"")+`">
...
`;const n="blk__card"+(Ut==="accent"?" blk__card--accent":"")+(Ut==="outlined"?" blk__card--outlined":"");for(let c=0;c<l;c++)Ut==="accent"?s+='      <div class="'+n+'" style="--_accent:'+He[c%He.length]+`">...</div>
`:s+='      <div class="'+n+`">...</div>
`;s+=`    </div>
`,s+=`  </div>
`,t&&(s+=`  <a class="blk__footer-link" href="#">View more</a>
`),s+="</div>",e.innerHTML=R(s)}function mt(){const a=document.getElementById("blk-live");if(!a)return;Sr();const t=Kt==="left"&&Bt!==3,e=qe==="center";a.className="blk"+(t?" blk--left":"");const d=a.querySelector(".blk__content");if(!d)return;const o=a.querySelector(".blk__header"),r=document.getElementById("blk-footer"),s=document.getElementById("blk-show-intro"),l=document.getElementById("blk-show-more"),n=s?s.checked:!0,c=l?l.checked:!0;o&&(o.style.display=n?"":"none",o.className="blk__header"+(e?" blk__header--center":"")),[document.getElementById("blk-intro-align-sep"),document.getElementById("blk-intro-align-label"),document.getElementById("blk-intro-align-pills")].forEach(m=>{m&&(m.style.display=n?"":"none")});let v="";if(Bt===3){v+='<div class="blk__grid blk__grid--3col">';for(let m=0;m<3&&m<Ce.length;m++)v+=da(m);v+="</div>"}else for(let m=0;m<Ce.length;m+=2)v+='<div class="blk__grid">',v+=da(m),m+1<Ce.length&&(v+=da(m+1)),v+="</div>";t&&c&&(v+='<a class="blk__footer-link" href="#">View more</a>'),d.innerHTML=v,r&&(r.style.display=!t&&c?"":"none"),Er(n,c)}function jr(){Kt="top",qe="left",Bt=2,Ut="none",Ia=1440,ns(1440,document.querySelector("#blk-breakout .lam-device")),mt();const a=document.getElementById("blk-device-bar");a&&a.querySelectorAll(".lam-device").forEach(s=>{s.addEventListener("click",()=>{const l=parseInt(s.dataset.width||"1440",10);a.querySelectorAll(".lam-device").forEach(n=>{n.classList.remove("on"),n.setAttribute("aria-checked","false")}),s.classList.add("on"),s.setAttribute("aria-checked","true"),ns(l,s)})}),["blk-show-intro","blk-show-more"].forEach(s=>{const l=document.getElementById(s);l&&l.addEventListener("change",()=>mt())});const t=document.getElementById("blk-copy-btn");t&&t.addEventListener("click",()=>{const s=document.getElementById("blk-code");s&&(S(s.textContent||""),j("Copied!"))});const e=document.getElementById("blk-align-pills");e&&D(e,s=>{Kt=s.dataset.val||"top",mt()});const d=document.getElementById("blk-intro-align-pills");d&&D(d,s=>{qe=s.dataset.val||"left",mt()});const o=document.getElementById("blk-cols-pills");o&&D(o,s=>{Bt=parseInt(s.dataset.val||"2",10),mt()});const r=document.getElementById("blk-border-pills");r&&D(r,s=>{Ut=s.dataset.val||"none",mt()})}const Fr=`
<div class="pg-controls">
  <div class="pg-controls__row">
  ...
  <div class="lam-breakout" id="blk-breakout">
    <div class="lam-viewport" id="blk-viewport" data-bp="desktop">
      <div class="blk" id="blk-live" data-surface="light">
        ...
        <div class="blk__content">
          <div class="blk__grid">${Ot[0]+Ot[1]}</div>
          <div class="blk__grid">${Ot[2]+Ot[3]}</div>
          <div class="blk__grid">${Ot[4]+Ot[5]}</div>
        </div>
...
`,Br={title:"Blocks",desc:"A grid of feature cards that scales, reflows, and never loses its rhythm.",tabs:["Preview","Specs"],content:[Fr,Cr],wide:!0,brandAware:!0,init:jr};function va(){return ht("/lam-sample.png")}function Ir(){return`<img src="${va()}" alt="Sample" style="width:100%;height:100%;min-height:300px;object-fit:cover;display:block" />`}let Ta="desktop",ha="center",$t="none",ba=!0,ie=!0,le=!0,ze=1440,Nt=null,Se=null;function xt(){const a=Ta==="mobile",t=ha==="left",e=$t==="right",d=$t==="bottom",o=$t==="full",r=document.getElementById("lam-combo-label"),s=o?"Img Full":e?"Img Right":d?"Img Bottom":"No Image",l=[];ba||l.push("media"),ie||l.push("eyebrow"),le||l.push("tertiary");let n=ze+"px · "+(t?"Left":"Center")+" · "+s;l.length&&(n+=" · -"+l.join(" -")),r&&(r.textContent=n);const c=e&&ze>768,h=t||c,v=h?"flex-start":"center",m=h?"left":"center",$=h?"flex-start":"center",F=Nt?'<img src="'+Nt+'" alt="" style="width:100%;height:100%;object-fit:cover;" />':Ir(),E=a?"GEAI is here":"GeneXus Enterprise AI is here",q='<div class="lam-eyebrow" role="status" aria-label="News: '+E+'"><span class="lam-eyebrow__icon" aria-hidden="true">'+Ds+'</span><span class="lam-eyebrow__tag">New</span><div class="lam-eyebrow__body"><span class="lam-eyebrow__text">'+E+'</span><span class="lam-eyebrow__dash" aria-hidden="true">—</span><a class="lam-eyebrow__cta" href="#">Read more <span aria-hidden="true">'+Sa+"</span></a></div></div>",I='<div class="lam-info" style="align-items:'+v+"; text-align:"+m+';">'+'<div class="lam-kicker">AI-Powered Enterprise Platform</div>'+'<h1 class="lam-title">Create enterprise software 10x faster</h1><div class="lam-paragraph">Build, integrate, and evolve mission-critical applications with the power of AI and low-code development.</div></div>',Dt='<div class="lam-cta" style="justify-content:'+$+';"><button class="jb jb--sec">Get started</button>'+(le?'<button class="jb jb--ter">Watch demo</button>':"")+"</div>",z="",tt=(ie?q:"")+I+Dt,$e='<div class="lam-bottom-image">'+F+"</div>";let G;if(a){const Ae='<div class="lam-mobile-content" style="align-items:'+v+"; text-align:"+m+';">'+tt+"</div>";o?G='<div class="lam-mobile-wrapper lam-mobile-wrapper--img-full"><img class="lam-container__bg" src="'+(Nt||va())+'" alt="" loading="lazy" />'+z+Ae+"</div>":G='<div class="lam-mobile-wrapper">'+z+Ae+(e||d?'<div class="lam-mobile-image">'+F+"</div>":"")+"</div>"}else if(e)G='<div class="lam-split"><div class="lam-split__content" style="align-items:'+v+"; text-align:"+m+';">'+tt+'</div><div class="lam-split__image">'+F+"</div></div>";else if(d)G=z+'<div class="lam-container" style="align-items:'+v+';">'+tt+"</div>"+$e;else if(o){const Ae=Nt||va();G=z+'<div class="lam-container lam-container--img-full" style="align-items:'+v+';"><img class="lam-container__bg" src="'+Ae+'" alt="" loading="lazy" />'+tt+"</div>"}else G=z+'<div class="lam-container" style="align-items:'+v+';">'+tt+"</div>";const te=document.getElementById("lam-preview");te&&(te.innerHTML=G);let _="";const et="  ";o&&!a?_+=`<div class="lam-container lam-container--img-full">
...
`;const N=e||a?"    ":et;ie&&(_+=N+`<div class="lam-eyebrow">...</div>
...
`,le&&(_+=N+`  <button class="jb jb--ter">Tertiary</button>
`),_+=N+`</div>
`,a?(_+=et+`</div>
...
`,_+="</div>"):d?_+=`</div>
<div class="lam-bottom-image"><img src="..." alt="..." /></div>`:_+="</div>";const Pa=document.getElementById("lam-code");Pa&&(Pa.innerHTML=R(_))}function Tr(a,t){ze=a;let e;if(a<=639?e="mobile":a<=1023?e="tablet":e="desktop",Ta=e,t){const n=t.closest(".lam-device-bar");n&&n.querySelectorAll(".lam-device").forEach(c=>c.classList.remove("on")),t.classList.add("on")}const d=document.getElementById("lam-viewport");if(d){d.setAttribute("data-bp",e),e==="desktop"&&a>=940?(d.style.width="100%",d.style.maxWidth="none",d.style.margin="0"):(d.style.width=a+"px",d.style.maxWidth="100%",d.style.margin="0 auto");const n=document.getElementById("lam-breakout");n&&(n.style.padding=e==="desktop"&&a>=940?"0":"24px")}const o=e.charAt(0).toUpperCase()+e.slice(1),r=document.getElementById("lam-width-label");r&&(r.textContent=o+" · "+a+"px");const s=e==="mobile"||e==="tablet",l=document.querySelectorAll("#lam-img-pills button");l.forEach(n=>{n.textContent.trim()==="Right"&&(n.style.display=s?"none":"")}),s&&$t==="right"&&($t="none",l.forEach(n=>{n.classList.toggle("on",n.textContent.trim()==="None")})),xt()}function Lr(a){if(!a.files||!a.files[0])return;const t=new FileReader;t.onload=e=>{Nt=e.target.result;const d=document.getElementById("lam-clear-img");d&&(d.style.display="flex");const o=document.getElementById("lam-upload-label");if(o){const r=o.querySelector("svg");r&&(r.style.display="none"),o.childNodes[2]&&(o.childNodes[2].textContent=" "+a.files[0].name.slice(0,18))}xt()},t.readAsDataURL(a.files[0])}function Pr(){Nt=null;const a=document.getElementById("lam-clear-img");a&&(a.style.display="none");const t=document.getElementById("lam-upload-label");if(t){const e=t.querySelector("svg");e&&(e.style.display=""),t.childNodes[2]&&(t.childNodes[2].textContent=`
        Upload image
      `)}xt()}function Dr(){ze=1440,Ta="desktop",ha="center",$t="none",ba=!0,ie=!0,le=!0,xt();const a=document.getElementById("lam-width-label");a&&(a.textContent="Desktop · 1440px"),Se&&Se.abort(),Se=new AbortController;const t={signal:Se.signal},e=document.getElementById("lam-device-bar");e&&e.querySelectorAll(".lam-device").forEach(c=>{c.addEventListener("click",()=>{const h=parseInt(c.dataset.width||"1440",10);e.querySelectorAll(".lam-device").forEach(v=>{v.classList.remove("on"),v.setAttribute("aria-checked","false")}),c.classList.add("on"),c.setAttribute("aria-checked","true"),Tr(h,c)},t)});const d=document.getElementById("lam-align-pills");d&&D(d,c=>{ha=c.dataset.val||"center",xt()});const o=document.getElementById("lam-img-pills");o&&D(o,c=>{$t=c.dataset.val||"none",xt()}),Object.entries({"lam-show-logo":c=>{ba=c},"lam-show-eyebrow":c=>{ie=c},"lam-show-secondary":c=>{le=c}}).forEach(([c,h])=>{const v=document.getElementById(c);v&&v.addEventListener("change",()=>{h(v.checked),xt()},t)});const s=document.getElementById("lam-upload-input");s&&s.addEventListener("change",()=>Lr(s),t);const l=document.getElementById("lam-clear-img");l&&l.addEventListener("click",Pr,t);const n=document.getElementById("lam-copy-btn");n&&n.addEventListener("click",()=>{const c=document.getElementById("lam-code");c&&(S(c.textContent||""),j("Copied!"))})}const Mr=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,Or={title:"Look at Me",desc:"First impression, fully yours. The hero section that adapts to any story.",tabs:["Preview","Specs"],content:[Mr,Rr],wide:!0,brandAware:!0,init:()=>{Dr()}};let X="desktop",ua="left",ne=!0,ce=!0,pe=!0,ve=!1;function cs(){return ht("/lam-sample.png")}function qr(a,t){if(X=a<=639?"mobile":a<=1023?"tablet":"desktop",t){const s=t.closest(".lam-device-bar");s&&s.querySelectorAll(".lam-device").forEach(l=>l.classList.remove("on")),t.classList.add("on")}const e=document.getElementById("sat-viewport");if(e){e.setAttribute("data-bp",X),X==="desktop"?(e.style.width="100%",e.style.maxWidth="none",e.style.margin="0"):(e.style.width=a+"px",e.style.maxWidth="100%",e.style.margin="0 auto");const s=document.getElementById("sat-breakout");s&&(s.style.padding=X==="desktop"?"0":"24px")}const d=document.getElementById("sat-pos-group");d&&(d.style.display=X==="desktop"?"contents":"none");const o=X.charAt(0).toUpperCase()+X.slice(1),r=document.getElementById("sat-width-label");r&&(r.textContent=o+" · "+a+"px"),Be()}function Be(){const a=ua==="right",t=document.getElementById("sat-combo-label");if(t){const n=["Text "+(a?"Right":"Left")],c=[];ne||c.push("icon"),ce||c.push("kicker"),pe||c.push("caption"),ve||c.push("footer"),c.length&&n.push("-"+c.join(" -")),t.textContent=n.join(" · ")}let e=`<div class="sat">
...
`,ne&&(e+='      <div class="sat__icon"><img src="'+cs()+`" alt="" style="width:64px;height:64px;object-fit:cover;border-radius:var(--r-xs);" /></div>
`),e+=`      <div class="sat__info">
`,ce&&(e+=`        <div class="sat__kicker">Productivity</div>
...
`,e+='      <div class="sat__media-wrap"><img src="'+cs()+`" alt="Platform screenshot" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block;" /></div>
`,pe&&(e+=`      <p class="sat__caption">Powered by deterministic and generative AI.</p>
`),e+=`    </div>
`,e+=`  </div>
`,ve&&(e+=`  <div class="sat__footer">
`,e+=`    <button class="jb jb--ter">Explore</button>
`,e+=`  </div>
...
`,ne&&(r+=s+s+s+`<div class="sat__icon"><img src="..." alt="..." /></div>
`),r+=s+s+s+`<div class="sat__info">
`,ce&&(r+=s+s+s+s+`<div class="sat__kicker">Kicker</div>
...
`,pe&&(r+=s+s+s+`<p class="sat__caption">Caption text</p>
`),r+=s+s+`</div>
`,r+=s+`</div>
`,ve&&(r+=s+`<div class="sat__footer">
`,r+=s+s+`<button class="jb jb--ter">Label +</button>
`,r+=s+`</div>
`),r+="</div>";const l=document.getElementById("sat-code");l&&(l.innerHTML=R(r))}function Hr(){X="desktop",ua="left",ne=!0,ce=!0,pe=!0,ve=!1,Be();const a=document.getElementById("sat-width-label");a&&(a.textContent="Desktop · 1440px");const t=document.getElementById("sat-device-bar");t&&t.querySelectorAll(".lam-device").forEach(r=>{r.addEventListener("click",()=>{const s=parseInt(r.dataset.width||"1440",10);t.querySelectorAll(".lam-device").forEach(l=>{l.classList.remove("on"),l.setAttribute("aria-checked","false")}),r.classList.add("on"),r.setAttribute("aria-checked","true"),qr(s,r)})});const e=document.getElementById("sat-pos-pills");e&&D(e,r=>{ua=r.dataset.val||"left",Be()}),Object.entries({"sat-show-icon":r=>{ne=r},"sat-show-kicker":r=>{ce=r},"sat-show-caption":r=>{pe=r},"sat-show-footer":r=>{ve=r}}).forEach(([r,s])=>{const l=document.getElementById(r);l&&l.addEventListener("change",()=>{s(l.checked),Be()})});const o=document.getElementById("sat-copy-btn");o&&o.addEventListener("click",()=>{const r=document.getElementById("sat-code");r&&(S(r.textContent||""),j("Copied!"))})}const zr=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,Nr={title:"Show and Tell",desc:"Tell the story on one side, show it on the other. Split layout with a centered headline.",tabs:["Preview","Specs"],content:[zr,Gr],wide:!0,brandAware:!0,init:()=>{Hr()}},Ur='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l2 6.5L21 12l-7 2.5L12 21l-2-6.5L3 12l7-2.5z"/></svg>';let H="desktop",ga="left",ma="bottom",he=!0,be=!0;function Vr(){return ht("/lam-sample.png")}const ps="AI-powered features available";function Wr(a,t){if(H=a<=639?"mobile":a<=1023?"tablet":"desktop",t){const l=t.closest(".lam-device-bar");l&&l.querySelectorAll(".lam-device").forEach(n=>n.classList.remove("on")),t.classList.add("on")}const e=document.getElementById("isl-viewport");if(e){e.setAttribute("data-bp",H),H==="desktop"?(e.style.width="100%",e.style.maxWidth="none",e.style.margin="0"):(e.style.width=a+"px",e.style.maxWidth="100%",e.style.margin="0 auto");const l=document.getElementById("isl-breakout");l&&(l.style.padding=H==="desktop"?"0":"24px")}const d=document.getElementById("isl-pos-group");d&&(d.style.display=H==="desktop"?"contents":"none");const o=document.getElementById("isl-media-group");o&&(o.style.display=H==="tablet"||H==="mobile"?"contents":"none");const r=H.charAt(0).toUpperCase()+H.slice(1),s=document.getElementById("isl-width-label");s&&(s.textContent=r+" · "+a+"px"),ae()}function ae(){const a=ga==="right",t=H==="tablet"||H==="mobile"?ma==="top":a,e=document.getElementById("isl-combo-label");if(e){const n=["Text "+(a?"Right":"Left")],c=[];he||c.push("eyebrow"),be||c.push("kicker"),c.length&&n.push("-"+c.join(" -")),e.textContent=n.join(" · ")}let d=`<div class="isl">
`;d+='  <div class="isl__card'+(t?" isl__card--right":"")+`">
`,d+=`    <div class="isl__text">
`,he&&(d+='      <div class="lam-eyebrow" role="status" aria-label="News: '+ps+'">',d+='<span class="lam-eyebrow__icon" aria-hidden="true">'+Ur+"</span>",d+='<span class="lam-eyebrow__tag">New</span>',d+='<div class="lam-eyebrow__body">',d+='<span class="lam-eyebrow__text">'+ps+"</span>",d+='<span class="lam-eyebrow__dash" aria-hidden="true">—</span>',d+='<a class="lam-eyebrow__cta" href="#">Read more <span aria-hidden="true">'+Sa+"</span></a>",d+=`</div></div>
`),d+=`      <div class="isl__info">
`,be&&(d+=`        <div class="isl__kicker">Productivity</div>
...
`,d+='      <img src="'+Vr()+`" alt="Platform screenshot" />
`,d+=`    </div>
`,d+=`  </div>
...
`,he&&(r+=s+s+s+`<div class="lam-eyebrow">
...
`,be&&(r+=s+s+s+s+`<div class="isl__kicker">Kicker</div>
...
`,r+=s+s+`</div>
`,r+=s+`</div>
`,r+="</div>";const l=document.getElementById("isl-code");l&&(l.innerHTML=R(r))}function Jr(){H="desktop",ga="left",ma="bottom",he=!0,be=!0,ae();const a=document.getElementById("isl-width-label");a&&(a.textContent="Desktop · 1440px");const t=document.getElementById("isl-device-bar");t&&t.querySelectorAll(".lam-device").forEach(s=>{s.addEventListener("click",()=>{const l=parseInt(s.dataset.width||"1440",10);t.querySelectorAll(".lam-device").forEach(n=>{n.classList.remove("on"),n.setAttribute("aria-checked","false")}),s.classList.add("on"),s.setAttribute("aria-checked","true"),Wr(l,s)})});const e=document.getElementById("isl-pos-pills");e&&D(e,s=>{ga=s.dataset.val||"left",ae()});const d=document.getElementById("isl-media-pills");d&&D(d,s=>{ma=s.dataset.val||"bottom",ae()}),Object.entries({"isl-show-eyebrow":s=>{he=s},"isl-show-kicker":s=>{be=s}}).forEach(([s,l])=>{const n=document.getElementById(s);n&&n.addEventListener("change",()=>{l(n.checked),ae()})});const r=document.getElementById("isl-copy-btn");r&&r.addEventListener("click",()=>{const s=document.getElementById("isl-code");s&&(S(s.textContent||""),j("Copied!"))})}const Kr=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,Xr={title:"Island",desc:"Content meets media in a rounded card — compact, versatile, always on brand.",tabs:["Preview","Specs"],content:[Kr,Yr],wide:!0,brandAware:!0,init:()=>{Jr()}},Qr=`
...
`;function vs(a){const t=(a.type==="textarea","june-field"),e=[];return a.type!=="text"&&e.push(`type="${a.type}"`),e.push(`label="${a.label}"`),a.placeholder&&e.push(`placeholder="${a.placeholder}"`),a.hint&&e.push(`hint="${a.hint}"`),a.error&&e.push(`error="${a.error}"`),a.required&&e.push("required show-required-text"),a.disabled&&e.push("disabled"),a.type==="dropdown"&&e.push('.options="${[...]}"'),`<${t}
  ${e.join(`
  `)}
></${t}>`}function ti(){const a=document.querySelector("#fld-playground > div:first-child");if(!a)return;const t=[{value:"opt1",label:"Option 1"},{value:"opt2",label:"Option 2"},{value:"opt3",label:"Option 3"}],e=document.getElementById("fld-pg-type"),d=document.getElementById("fld-pg-label"),o=document.getElementById("fld-pg-placeholder"),r=document.getElementById("fld-pg-hint"),s=document.getElementById("fld-pg-error"),l=document.getElementById("fld-pg-required"),n=document.getElementById("fld-pg-disabled"),c=document.getElementById("fld-code"),h=document.getElementById("fld-copy-btn"),v={text:{label:"Full name",placeholder:"John Doe",hint:"As it appears on your ID"},email:{label:"Email address",placeholder:"you@example.com",hint:"We'll never share your email"},password:{label:"Password",placeholder:"Enter your password",hint:"At least 8 characters"},number:{label:"Amount",placeholder:"0",hint:""},tel:{label:"Phone number",placeholder:"+1 (555) 000-0000",hint:"Include country code"},url:{label:"Website",placeholder:"https://example.com",hint:""},search:{label:"Search",placeholder:"Search...",hint:""},textarea:{label:"Message",placeholder:"Write your message...",hint:"Max 500 characters"},dropdown:{label:"Choose an option",placeholder:"Select one",hint:""}};e&&e.addEventListener("change",()=>{const I=v[e.value];I&&(d&&(d.value=I.label),o&&(o.value=I.placeholder),r&&(r.value=I.hint),s&&(s.value=""),l&&(l.checked=!1),n&&(n.checked=!1))}),customElements.whenDefined("june-field").then(()=>{const I=document.getElementById("fld-pg-field");I&&(I.options=t)});function m(){return[e==null?void 0:e.value,d==null?void 0:d.value,o==null?void 0:o.value,r==null?void 0:r.value,s==null?void 0:s.value,l==null?void 0:l.checked,n==null?void 0:n.checked].join("|")}let $=m();function F(){const I=(e==null?void 0:e.value)||"text",Dt=(d==null?void 0:d.value)||"Label",z=(o==null?void 0:o.value)||"",tt=(r==null?void 0:r.value)||"",$e=(s==null?void 0:s.value)||"",G=(l==null?void 0:l.checked)||!1,te=(n==null?void 0:n.checked)||!1,_=document.createElement("june-field");_.id="fld-pg-field",_.style.width="100%",_.style.maxWidth="360px",_.type=I,_.label=Dt,_.placeholder=z,_.hint=tt,_.error=$e,_.required=G,_.disabled=te,_.showRequiredText=G,I==="dropdown"&&(_.options=t),a.replaceChildren(_),c&&(c.innerHTML=R(vs({type:I,label:Dt,placeholder:z,hint:tt,error:$e,required:G,disabled:te}))),$=m()}let E=!0;function q(){!E||!document.getElementById("fld-playground")||(m()!==$&&F(),requestAnimationFrame(q))}requestAnimationFrame(q);const K=new MutationObserver(()=>{document.getElementById("fld-playground")||(E=!1,K.disconnect())});K.observe(document.getElementById("page"),{childList:!0}),h&&h.addEventListener("click",()=>{c&&(S(c.textContent||""),j("Copied!"))}),c&&(c.innerHTML=R(vs({type:"email",label:"Email address",placeholder:"you@example.com",hint:"We'll never share your email",error:"",required:!1,disabled:!1})))}function ei(){document.querySelectorAll('june-field[type="dropdown"]').forEach(a=>{const t=a.getAttribute(".options");if(t)try{a.options=JSON.parse(t)}catch{}})}const ai={title:"Field",desc:"Every form input, one component. Accessible by default, validation built in.",tabs:["Preview","Specs"],content:[Qr,Zr],brandAware:!0,init(){ei(),ti()}};let yt="desktop",Ge=!0,Ne=!0,At="light";function si(){return'<img src="'+ht("/hero-logo.png")+'" alt="June" />'}function oi(a,t){if(yt=a<=639?"mobile":a<=1023?"tablet":"desktop",t){const r=t.closest(".lam-device-bar");r&&r.querySelectorAll(".lam-device").forEach(s=>s.classList.remove("on")),t.classList.add("on")}const e=document.getElementById("scb-viewport");if(e){e.setAttribute("data-bp",yt),yt==="desktop"?(e.style.width="100%",e.style.maxWidth="none",e.style.margin="0"):(e.style.width=a+"px",e.style.maxWidth="100%",e.style.margin="0 auto");const r=document.getElementById("scb-breakout");r&&(r.style.padding=yt==="desktop"&&a>=940?"0":"24px")}const d=yt.charAt(0).toUpperCase()+yt.slice(1),o=document.getElementById("scb-width-label");o&&(o.textContent=d+" · "+a+"px"),se()}function hs(){return At==="dark"?" scb--dark":At==="accent"?" scb--accent":""}function se(){const a=document.getElementById("scb-preview");a&&a.setAttribute("data-surface",At==="light"?"light":"dark");let t='<div class="scb'+hs()+`">
`;t+=`  <div class="scb__inner">
`,t+=`    <div class="scb__info">
`,t+=`      <div class="scb__text">
`,t+=`        <h2 class="scb__title">Form title example</h2>
`,Ne&&(t+=`        <p class="scb__body">This is an example body text for the contact box.</p>
`),t+=`      </div>
`,Ge&&(t+=`      <div class="scb__avatar">
`,t+="        "+si()+`
...
`;const e=At==="light"?"jb--sec":"jb--ter";t+=`      <div style="padding-top:var(--sp-2);">
`,t+='        <button class="jb '+e+`" style="border-radius:var(--r-full);">Send</button>
`,t+=`      </div>
`,t+=`    </div>
`,t+=`  </div>
`,t+="</div>";const d=document.getElementById("scb-preview");d&&(d.innerHTML=t);let o="";const r="  ",s=At==="light"?"scb":"scb"+hs();o+='<div class="'+s+`">
`,o+=r+`<div class="scb__inner">
`,o+=r+r+`<div class="scb__info">
`,o+=r+r+r+`<div class="scb__text">
`,o+=r+r+r+r+`<h2 class="scb__title">Title</h2>
`,Ne&&(o+=r+r+r+r+`<p class="scb__body">Body text</p>
`),o+=r+r+r+`</div>
`,Ge&&(o+=r+r+r+`<div class="scb__avatar">
...
`,o+=r+r+`</div>
`,o+=r+`</div>
`,o+="</div>";const l=document.getElementById("scb-code");l&&(l.innerHTML=R(o))}function di(){yt="desktop",Ge=!0,Ne=!0,At="light",se();const a=document.getElementById("scb-width-label");a&&(a.textContent="Desktop · 1440px");const t=document.getElementById("scb-device-bar");t&&t.querySelectorAll(".lam-device").forEach(s=>{s.addEventListener("click",()=>{const l=parseInt(s.dataset.width||"1440",10);t.querySelectorAll(".lam-device").forEach(n=>{n.classList.remove("on"),n.setAttribute("aria-checked","false")}),s.classList.add("on"),s.setAttribute("aria-checked","true"),oi(l,s)})});const e=document.getElementById("scb-surface-pills");e&&D(e,s=>{At=s.dataset.val||"light",se()}),Object.entries({"scb-show-avatar":s=>{Ge=s},"scb-show-body":s=>{Ne=s}}).forEach(([s,l])=>{const n=document.getElementById(s);n&&n.addEventListener("change",()=>{l(n.checked),se()})});const o=document.getElementById("page");o&&new MutationObserver(()=>se()).observe(o,{attributes:!0,attributeFilter:["data-brand"]});const r=document.getElementById("scb-copy-btn");r&&r.addEventListener("click",()=>{const s=document.getElementById("scb-code");s&&(S(s.textContent||""),j("Copied!"))})}const ri=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,li={title:"Smiley Contact Box",desc:"Put a face on your contact form. Avatar and fields, side by side.",tabs:["Preview","Specs"],content:[ri,ii],wide:!0,brandAware:!0,init:()=>{di()}},ni='<span class="jb__i"><svg width="20" height="20" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8h10M9 4l4 4-4 4"/></svg></span>';let _t="desktop",Ue=!0,Ve=!0,ya=!1;function ci(a,t){if(_t=a<=639?"mobile":a<=1023?"tablet":"desktop",t){const r=t.closest(".lam-device-bar");r&&r.querySelectorAll(".lam-device").forEach(s=>s.classList.remove("on")),t.classList.add("on")}const e=document.getElementById("lm-viewport");if(e){e.setAttribute("data-bp",_t),_t==="desktop"?(e.style.width="100%",e.style.maxWidth="none",e.style.margin="0"):(e.style.width=a+"px",e.style.maxWidth="100%",e.style.margin="0 auto");const r=document.getElementById("lm-breakout");r&&(r.style.padding=_t==="desktop"&&a>=940?"0":"24px")}const d=_t.charAt(0).toUpperCase()+_t.slice(1),o=document.getElementById("lm-width-label");o&&(o.textContent=d+" · "+a+"px"),oe()}function oe(){let t='<div class="lm" data-surface="'+(ya?"dark":"light")+`">
`;t+=`  <div class="lm__text">
`,t+=`    <h2 class="lm__title">Unlock your potential with our platform</h2>
`,Ue&&(t+=`    <div class="lm__body">
...
`,Ve&&(t+='    <button class="jb jb--out" style="border-radius:var(--r-full);">Learn more '+ni+`</button>
`),t+=`  </div>
...
`,Ue&&(d+=o+o+`<div class="lm__body">
`,d+=o+o+o+`<p>Body text paragraph.</p>
`,d+=o+o+`</div>
`),d+=o+`</div>
`,d+=o+`<div class="lm__cta">
`,d+=o+o+`<button class="jb jb--ter">Tertiary</button>
`,Ve&&(d+=o+o+`<button class="jb jb--out">Outline <span class="jb__i"><!-- icon --></span></button>
`),d+=o+`</div>
`,d+="</div>";const r=document.getElementById("lm-code");r&&(r.innerHTML=R(d))}function pi(){_t="desktop",Ue=!0,Ve=!0,ya=!1,oe();const a=document.getElementById("lm-width-label");a&&(a.textContent="Desktop · 1440px");const t=document.getElementById("lm-device-bar");t&&t.querySelectorAll(".lam-device").forEach(s=>{s.addEventListener("click",()=>{const l=parseInt(s.dataset.width||"1440",10);t.querySelectorAll(".lam-device").forEach(n=>{n.classList.remove("on"),n.setAttribute("aria-checked","false")}),s.classList.add("on"),s.setAttribute("aria-checked","true"),ci(l,s)})});const e=document.getElementById("lm-show-body");e&&e.addEventListener("change",()=>{Ue=e.checked,oe()});const d=document.getElementById("lm-show-second-cta");d&&d.addEventListener("change",()=>{Ve=d.checked,oe()});const o=document.getElementById("lm-dark-surface");o&&o.addEventListener("change",()=>{ya=o.checked,oe()});const r=document.getElementById("lm-copy-btn");r&&r.addEventListener("click",()=>{const s=document.getElementById("lm-code");s&&(S(s.textContent||""),j("Copied!"))})}const vi=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,bi={title:"Learn More",desc:"Title, context, CTA — the section that nudges the next step.",tabs:["Preview","Specs"],content:[vi,hi],wide:!0,brandAware:!0,init:pi},ui='<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 12.5l9-9M5.5 3.5h7v7"/></svg>',gi='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',mi='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>';function Vs(){return ht("/lam-sample.png")}function yi(){return'<img src="'+Vs()+'" alt="Company logo" />'}let O="news",zt="desktop",Yt=!0,nt=!0,It=!0,St=4,T=0,ot=!1,ut=null;function bs(a,t,e,d,o){const r="cr-tag-"+a,s="cr-title-"+a;let l='<li><article class="cr__card" aria-labelledby="'+s+'">';if(nt){const n=["center 30%","center 50%","center 70%","center 20%","center 60%","center 40%"];l+='<div class="cr__card-img"><img src="'+Vs()+'" alt="" style="object-position:'+n[a%n.length]+'" /></div>'}return l+='<div class="cr__card-content">',It&&(l+='<span class="cr__card-tag" id="'+r+'">'+t+"</span>"),l+='<h4 class="cr__card-title" id="'+s+'">'+e+"</h4>",l+='<p class="cr__card-body">'+d+"</p>",l+='<a class="cr__card-link" href="#"'+(It?' aria-describedby="'+r+'"':"")+">"+o+" "+ui+"</a>",l+="</div>",l+="</article></li>",l}function _i(a,t,e,d,o){const r="cr-qname-"+a;let s='<li><article class="cr__card cr__card--quote" aria-labelledby="'+r+'">';return s+='<div class="cr__card-content">',s+='<div class="cr__card-meta">',s+='<div class="cr__card-name" id="'+r+'">'+t+"</div>",s+='<div class="cr__card-role">'+e+"</div>",s+="</div>",s+='<blockquote class="cr__card-body">'+d+"</blockquote>",o&&nt&&(s+='<div class="cr__card-logo">'+yi()+"</div>"),s+="</div>",s+="</article></li>",s}function us(){let a='<li><article class="cr__card cr__card--skeleton" aria-hidden="true">';return nt&&(a+='<div class="cr__skel cr__skel--img"></div>'),a+='<div class="cr__card-content">',It&&(a+='<div class="cr__skel cr__skel--tag"></div>'),a+='<div class="cr__skel cr__skel--title"></div>',a+='<div class="cr__skel cr__skel--body"></div>',a+='<div class="cr__skel cr__skel--body"></div>',a+='<div class="cr__skel cr__skel--short"></div>',a+='<div class="cr__skel cr__skel--link"></div>',a+="</div>",a+="</article></li>",a}function fi(){let a='<li><article class="cr__card cr__card--quote cr__card--skeleton" aria-hidden="true">';return a+='<div class="cr__card-content">',a+='<div class="cr__card-meta">',a+='<div class="cr__skel cr__skel--title" style="width:50%"></div>',a+='<div class="cr__skel cr__skel--tag"></div>',a+="</div>",a+='<div class="cr__skel cr__skel--body"></div>',a+='<div class="cr__skel cr__skel--body"></div>',a+='<div class="cr__skel cr__skel--short"></div>',a+="</div>",nt&&(a+='<div class="cr__card-logo"><div class="cr__skel" style="width:120px;height:36px;border-radius:var(--r-xs)"></div></div>'),a+="</article></li>",a}function ra(){let a='<div class="cr__nav">';a+='<button type="button" class="cr__prev" aria-label="Previous">'+gi+"</button>",a+='<div class="cr__dots" role="group" aria-label="Carousel navigation">';for(let t=0;t<St;t++){const e=t===0;a+='<button type="button" class="cr__dot'+(e?" cr__dot--on":"")+'" data-idx="'+t+'" aria-label="Go to card '+(t+1)+'"'+(e?' aria-current="true"':"")+"></button>"}return a+="</div>",a+='<button type="button" class="cr__next" aria-label="Next">'+mi+"</button>",a+="</div>",a}function ia(){return'<p class="cr__live" aria-live="polite" aria-atomic="true"></p>'}const Ee=[{tag:"Product",title:"AI-Powered Insights",body:"Transform raw data into actionable intelligence with our advanced AI models and real-time analytics. Build intelligent applications that understand context.",link:"Read more"},{tag:"Engineering",title:"Scalable Infrastructure",body:"Build on a foundation designed for enterprise-grade performance, from prototype to production. Our architecture scales seamlessly with your needs.",link:"Learn more"},{tag:"Research",title:"Next-Gen Models",body:"Pushing the boundaries of what’s possible with foundation models trained on diverse, curated datasets. State-of-the-art performance across benchmarks.",link:"Explore"},{tag:"Design",title:"Adaptive Interfaces",body:"Craft experiences that adapt to user behavior with intelligent layout systems and context-aware components. Ship beautiful products faster.",link:"See details"},{tag:"Security",title:"Enterprise-Grade Safety",body:"Built-in guardrails and advanced monitoring ensure your AI deployments meet the highest standards of safety and compliance.",link:"Read more"},{tag:"Platform",title:"Developer Experience",body:"From APIs to SDKs, everything is designed to reduce friction and help your team move from idea to production in record time.",link:"Discover"}],gs=[{name:"Sarah Chen",role:"CTO, Acme Corp",quote:"“The platform transformed how our engineering team ships features. We’ve cut our development cycle in half and our code quality has never been higher.”",logo:!0},{name:"Marcus Johnson",role:"VP Engineering, Scale AI",quote:"“Integration was seamless. The AI-powered tools understand our codebase and suggest meaningful improvements that our team actually wants to adopt.”",logo:!0},{name:"Elena Rodriguez",role:"Head of Product, Stripe",quote:"“The developer experience is unmatched. Our team adopted it within a week and hasn’t looked back. It fundamentally changed our workflow.”",logo:!0},{name:"David Park",role:"Lead Architect, Notion",quote:"“We replaced three internal tools with a single integration. The ROI was clear within the first month of deployment.”",logo:!0},{name:"Aisha Patel",role:"Director of Engineering, Figma",quote:"“The quality of code suggestions is remarkable. It understands our patterns and proposes changes that align with our architecture.”",logo:!0},{name:"James Wright",role:"CTO, Linear",quote:"“Our team’s velocity increased by 40% after adoption. The tooling just gets out of your way and lets you focus on building.”",logo:!0}];function ms(a,t){if(zt=a<=639?"mobile":a<=1023?"tablet":"desktop",t){const r=t.closest(".lam-device-bar");r&&r.querySelectorAll(".lam-device").forEach(s=>s.classList.remove("on")),t.classList.add("on")}const e=document.getElementById("cr-viewport");if(e){e.setAttribute("data-bp",zt),zt==="desktop"?(e.style.width="100%",e.style.maxWidth="none",e.style.margin="0"):(e.style.width=a+"px",e.style.maxWidth="100%",e.style.margin="0 auto");const r=document.getElementById("cr-breakout");r&&(r.style.padding="0")}const d=zt.charAt(0).toUpperCase()+zt.slice(1),o=document.getElementById("cr-width-label");o&&(o.textContent=d+" · "+a+"px"),at()}function U(a){var K;const t=document.getElementById("cr-preview");if(!t)return;const e=t.querySelector(".cr__track"),d=t.querySelector(".cr__row");if(!e||!d)return;const o=e.querySelectorAll(".cr__card");if(o.length<2)return;const r=o[1].offsetLeft-o[0].offsetLeft,s=o[0].offsetWidth,l=r-s,n=o.length*s+(o.length-1)*l,c=getComputedStyle(d),h=d.clientWidth-parseFloat(c.paddingLeft)-parseFloat(c.paddingRight),v=Math.max(0,n-h),m=v>0?Math.ceil(v/r):0;T=Math.max(0,Math.min(a,m));const $=Math.min(T*r,v);e.style.transform="translateX(-"+$+"px)";const F=t.querySelector(".cr__prev"),E=t.querySelector(".cr__next");F&&(F.style.opacity=T>0?"1":"0",F.style.pointerEvents=T>0?"auto":"none"),E&&(E.style.opacity=T<m?"1":"0",E.style.pointerEvents=T<m?"auto":"none"),t.querySelectorAll(".cr__dot").forEach((I,Dt)=>{const z=Dt===T;I.classList.toggle("cr__dot--on",z),z?I.setAttribute("aria-current","true"):I.removeAttribute("aria-current")}),d&&(T>=m?d.setAttribute("data-at-end",""):d.removeAttribute("data-at-end"));const q=(K=t.closest(".cr"))==null?void 0:K.querySelector(".cr__live");q&&(q.textContent="Card "+(T+1)+" of "+St)}function ki(){T=0;const a=document.getElementById("cr-preview");if(!a)return;const t=a.querySelector(".cr__prev"),e=a.querySelector(".cr__next");t&&t.addEventListener("click",()=>U(T-1)),e&&e.addEventListener("click",()=>U(T+1)),a.querySelectorAll(".cr__dot").forEach(o=>{o.addEventListener("click",()=>{const r=parseInt(o.dataset.idx||"0",10);U(r)})});const d=a.querySelector(".cr__row");if(d){d.addEventListener("keydown",l=>{l.key==="ArrowLeft"?(l.preventDefault(),U(T-1)):l.key==="ArrowRight"?(l.preventDefault(),U(T+1)):l.key==="Home"?(l.preventDefault(),U(0)):l.key==="End"&&(l.preventDefault(),U(St-1))});let o=0,r=0,s=!1;d.addEventListener("touchstart",l=>{o=l.touches[0].clientX,r=l.touches[0].clientY,s=!1},{passive:!0}),d.addEventListener("touchmove",l=>{const n=l.touches[0].clientX-o,c=l.touches[0].clientY-r;!s&&Math.abs(n)>Math.abs(c)&&Math.abs(n)>10&&(s=!0),s&&l.preventDefault()},{passive:!1}),d.addEventListener("touchend",l=>{if(!s)return;const n=l.changedTouches[0].clientX-o,c=50;n<-c?U(T+1):n>c&&U(T-1)},{passive:!0})}U(0)}function xi(){const a=document.getElementById("cr-preview");if(!a)return;const e=`
  ...
  `;a.innerHTML=e}function wi(){ot=!0,at()}window.crRetry=wi;function at(){const a=document.getElementById("cr-preview");if(!a)return;let t="";if(O==="news"){t+='<div class="cr" data-surface="light">',Yt&&(t+='<div class="cr__header">',t+='<div class="cr__kicker">News</div>',t+='<h3 class="cr__title">Latest updates</h3>',t+='<p class="cr__desc">Stay informed with the latest developments across our platform and research.</p>',t+="</div>"),t+='<div class="cr__row" role="region" aria-roledescription="carousel" aria-label="Latest updates" tabindex="0">',t+='<ul class="cr__track">';for(let e=0;e<St;e++)if(ot)t+=us();else{const d=Ee[e%Ee.length];t+=bs(e,d.tag,d.title,d.body,d.link)}t+="</ul>",t+="</div>",t+=ra(),t+=ia(),t+="</div>"}else if(O==="quotes"){t+='<div class="cr cr--quotes" data-surface="light">',Yt&&(t+='<div class="cr__header">',t+='<div class="cr__kicker">Testimonials</div>',t+='<h3 class="cr__title">What people are saying</h3>',t+='<p class="cr__desc">Hear from the teams building with our platform every day.</p>',t+="</div>"),t+='<div class="cr__carousel">',t+='<div class="cr__row" role="region" aria-roledescription="carousel" aria-label="Testimonials" tabindex="0">',t+='<ul class="cr__track">';for(let e=0;e<St;e++)if(ot)t+=fi();else{const d=gs[e%gs.length];t+=_i(e,d.name,d.role,d.quote,d.logo)}t+="</ul>",t+="</div>",t+=ra(),t+="</div>",t+=ia(),t+="</div>"}else if(O==="split"){t+='<div class="cr cr--split" data-surface="light">',t+='<div class="cr__resume">',t+='<div class="cr__resume-kicker">Featured</div>',t+='<h3 class="cr__resume-title">Build the future of AI</h3>',t+='<p class="cr__resume-body">Our platform provides everything you need to create, deploy, and scale intelligent applications that transform your business.</p>',t+='<div class="cr__resume-actions">',t+='<button type="button" class="jb jb--sec">Get started</button>',t+='<button type="button" class="jb jb--ter">Learn more</button>',t+="</div>",t+="</div>",t+='<div class="cr__carousel">',t+='<div class="cr__row" role="region" aria-roledescription="carousel" aria-label="Featured articles" tabindex="0">',t+='<ul class="cr__track">';for(let e=0;e<St;e++)if(ot)t+=us();else{const d=Ee[e%Ee.length];t+=bs(e,d.tag,d.title,d.body,d.link)}t+="</ul>",t+="</div>",t+=ra(),t+="</div>",t+=ia(),t+="</div>"}a.innerHTML=t,ki(),$i(),ot?(ut!==null&&clearTimeout(ut),ut=window.setTimeout(()=>{ot=!1,xi(),ut=null},1e4)):ut!==null&&(clearTimeout(ut),ut=null)}function $i(){const a=document.getElementById("cr-code");if(!a)return;const t="  ";let e="";e+='<div class="cr'+(O==="quotes"?" cr--quotes":O==="split"?" cr--split":"")+`">
...
`),l+=s+t+t+t+t+`<div class="cr__card-content">
`,It&&(l+=s+t+t+t+t+t+`<span class="cr__card-tag" id="tag-id">Tag</span>
`),l+=s+t+t+t+t+t+`<h4 class="cr__card-title" id="title-id">Card title</h4>
`,l+=s+t+t+t+t+t+`<p class="cr__card-body">Card body text</p>
`,l+=s+t+t+t+t+t+'<a class="cr__card-link" href="#"'+(It?' aria-describedby="tag-id"':"")+`>Link</a>
`,l+=s+t+t+t+t+`</div>
`,l+=s+t+t+t+`</article>
`,l+=s+t+t+`</li>
...
`),l+=s+t+`</ul>
`,l+=s+`</div>
`,l}O==="news"?(Yt&&(e+=t+`<div class="cr__header">
...
`,e+="</div>",a.innerHTML=R(e)}function Ai(){O="news",zt="desktop",Yt=!0,nt=!0,It=!0,St=4,T=0,ot=!1,ms(1440,document.querySelector("#cr-breakout .lam-device")),at();const a=document.getElementById("cr-device-bar");a&&a.querySelectorAll(".lam-device").forEach(l=>{l.addEventListener("click",()=>{const n=parseInt(l.dataset.width||"1440",10);a.querySelectorAll(".lam-device").forEach(c=>{c.classList.remove("on"),c.setAttribute("aria-checked","false")}),l.classList.add("on"),l.setAttribute("aria-checked","true"),ms(n,l)})});const t=document.getElementById("cr-layout-pills");t&&D(t,l=>{O=l.dataset.val||"news";const n=document.getElementById("cr-desc-group");n&&(n.style.display=O==="split"?"none":"");const c=document.getElementById("cr-img-label");c&&(c.textContent=O==="quotes"?"Logo":"Image");const h=document.getElementById("cr-tag-group");h&&(h.style.display=O==="quotes"?"none":""),at()});const e=document.getElementById("cr-show-desc");e&&e.addEventListener("change",()=>{Yt=e.checked,at()});const d=document.getElementById("cr-show-img");d&&d.addEventListener("change",()=>{nt=d.checked,at()});const o=document.getElementById("cr-show-tag");o&&o.addEventListener("change",()=>{It=o.checked,at()});const r=document.getElementById("cr-show-skeleton");r&&r.addEventListener("change",()=>{ot=r.checked,at()});const s=document.getElementById("cr-copy-btn");s&&s.addEventListener("click",()=>{const l=document.getElementById("cr-code");l&&(S(l.textContent||""),j("Copied!"))})}const Si=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,ji={title:"Card Row",desc:"Cards in a row, scrolling on demand. Three layouts for news, quotes, and stories.",tabs:["Preview","Specs"],content:[Si,Ei],wide:!0,brandAware:!0,init:Ai},Ws=`
<style>
.il-toolbar {
  display: flex;
  align-items: center;
...
`,ys=ja[ye[0]??""]||'<svg viewBox="0 0 64 64"><circle cx="32" cy="32" r="24" fill="var(--icon-fill)" stroke="var(--icon-line)" stroke-width="2"/><circle cx="32" cy="32" r="10" fill="var(--icon-accent)"/></svg>';function Fi(){return ye.length===0?'<div class="il-empty">No illustrations found. Run <code>npm run fetch-illustrations && npm run illustrations</code> first.</div>':ye.map(a=>{const t=ja[a]||"";return`<div class="il-card" data-name="${a}" title="Click to copy SVG">
...
<div class="il-toolbar">
  ...
  <span class="il-count" id="ilCount">${ye.length} illustration${ye.length!==1?"s":""}</span>
</div>
...
<div class="vcard" id="il-brand-surface" style="margin-bottom:var(--sp-7);"><div class="vcard__head"><span class="vcard__name">Brand × Surface</span></div><div class="vcard__body" style="padding:0;">
  <table class="tok-table"><thead><tr><th></th><th>GX</th><th>NX</th><th>GE</th></tr></thead><tbody>
    <tr>
      <td>Light</td>
      ${["gx","nx","ge"].map(a=>`<td data-brand="${a}" data-surface="light" style="background:#FFFFFF;padding-left:var(--sp-3);padding-right:var(--sp-3)"><div style="width:64px;height:64px">${ys}</div></td>`).join("")}
    </tr>
    <tr>
      <td style="font-weight:600;background:var(--grey-900);color:#fff;">Dark</td>
      ${["gx","nx","ge"].map(a=>`<td data-brand="${a}" data-surface="dark" style="background:var(--grey-900);padding-left:var(--sp-3);padding-right:var(--sp-3)"><div style="width:64px;height:64px">${ys}</div></td>`).join("")}
    </tr>
  </tbody></table>
</div></div>
...
</div></div>`;function Ii(){const a=document.getElementById("page");if(!a)return;a.addEventListener("click",r=>{const s=r.target.closest("[data-surface]");if(!s||!s.closest('.pills[aria-label="Surface"]'))return;const l=s.dataset.surface;if(!l)return;const n=document.getElementById("ilGrid");n&&n.setAttribute("data-surface",l);const c=s.closest(".pills");c&&c.querySelectorAll("button").forEach(h=>{const v=h.dataset.surface===l;h.classList.toggle("on",v),h.setAttribute("aria-checked",String(v))})});const t=document.getElementById("ilSearch"),e=document.getElementById("ilGrid"),d=document.getElementById("ilCount");t&&e&&t.addEventListener("input",()=>{const r=t.value.toLowerCase().trim(),s=e.querySelectorAll(".il-card");let l=0;s.forEach(n=>{const c=n.dataset.name||"",h=!r||c.includes(r);n.style.display=h?"":"none",h&&l++}),d&&(d.textContent=`${l} illustration${l!==1?"s":""}`)});const o={light:{"var(--icon-accent)":"#5BA7FF","var(--icon-line)":"#111111","var(--icon-fill)":"#E2E8EF","var(--icon-bg)":"#FFFFFF"},dark:{"var(--icon-accent)":"#5BA7FF","var(--icon-line)":"#FFFFFF","var(--icon-fill)":"#3E4853","var(--icon-bg)":"#1B1F23"}};a.addEventListener("click",r=>{const s=r.target.closest(".il-card");if(!s)return;const l=s.dataset.name||"",n=ja[l]||"",c=document.getElementById("ilGrid"),h=(c==null?void 0:c.getAttribute("data-surface"))==="dark"?"dark":"light",v=o[h],m=n.replace(/var\(--icon-[a-z]+\)/g,K=>v[K]||K).replace("<svg ",'<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" ');S(m);const $=s.querySelector(".il-card__copy");$&&($.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',$.classList.add("copied"),setTimeout(()=>{$.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>',$.classList.remove("copied")},1200));const F=h==="dark"?"#1B1F23":"#FFFFFF",E=h==="dark"?"rgba(255,255,255,0.12)":"rgba(0,0,0,0.08)",q=m.replace(/width="64" height="64" /,"");j(`<span class="copy-toast__thumb" style="background:${F};border:1px solid ${E}">${q}</span> Copied: ${l}`)})}const Ti={title:"Illustrations",desc:"Spot art that breathes with your palette. Three layers: accent, line, fill.",tabs:["Catalog","Specs"],content:[Ci,Bi],init:Ii};function _a(){return ht("/lam-sample.png")}const Li='<svg class="dd__item-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><line class="dd__icon-h" x1="3" y1="9" x2="15" y2="9"/><line class="dd__icon-v" x1="9" y1="3" x2="9" y2="15"/></svg>',Pi='<svg class="dd__item-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><line class="dd__icon-h" x1="5" y1="12" x2="19" y2="12"/><line class="dd__icon-v" x1="12" y1="5" x2="12" y2="19"/></svg>',Di='<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 12.5l9-9M5.5 3.5h7v7"/></svg>';let ke="rich",V="",Gt="desktop",rt=0;const Ie=[{name:"Finance",desc:"Leading financial institutions trust our platform to power intelligent automation, fraud detection, and real-time analytics across global markets.",link:"Read the story"},{name:"Healthcare",desc:"Hospitals and research labs leverage AI-driven diagnostics and patient management systems built on our enterprise-grade infrastructure.",link:"Read the story"},{name:"Technology",desc:"Top tech companies integrate our APIs to ship AI-powered features faster, from code generation to natural language search.",link:"Read the story"},{name:"Education",desc:"Universities and edtech platforms use personalized learning models to improve student outcomes at scale.",link:"Read the story"},{name:"Retail",desc:"Global retailers deploy recommendation engines and demand forecasting models that drive measurable revenue growth.",link:"Read the story"}],_s=[{name:"What is the free trial period?",desc:"The free trial lasts 14 days and includes full access to all platform features. No credit card required to start."},{name:"How does pricing scale?",desc:"Pricing is based on API usage with volume discounts. Enterprise plans include dedicated support and custom SLAs."},{name:"Can I migrate from another provider?",desc:"Yes. We provide migration tooling and dedicated onboarding support to help you transition without downtime."},{name:"What security certifications do you have?",desc:"We are SOC 2 Type II certified, GDPR compliant, and undergo annual third-party security audits."},{name:"Is there an on-premise deployment option?",desc:"Enterprise customers can deploy on-premise or in a private cloud environment. Contact sales for details."},{name:"What support channels are available?",desc:"All plans include email support. Pro and Enterprise plans add live chat and dedicated Slack channels with guaranteed response times."},{name:"How do I get started with the API?",desc:"Sign up for a free account, grab your API key from the dashboard, and follow our quickstart guide. Most teams are up and running in under an hour."}];function Mi(){let a='<div class="dd"'+(V?' data-split="'+V+'"':"")+' data-surface="light">';a+='<div class="dd__header">',a+='<h2 class="dd__title">Trusted by a lot of cool companies across all industries</h2>',a+='<p class="dd__strapline">Discover how businesses worldwide leverage our platform to transform their operations and drive innovation.</p>',a+="</div>",a+='<div class="dd__body">',a+='<div class="dd__list">';for(let t=0;t<Ie.length;t++){const e=Ie[t],d=t===rt;a+='<div class="dd__item'+(d?" dd__item--on":"")+'" data-idx="'+t+'">',a+='<div class="dd__item-head" role="button" tabindex="0" aria-expanded="'+d+'">',a+='<span class="dd__item-name">'+e.name+"</span>",a+=Li,a+="</div>",a+='<div class="dd__item-body">',a+='<div class="dd__item-content">',a+='<p class="dd__item-desc">'+e.desc+"</p>",a+='<a class="dd__item-link" href="#">'+e.link+" "+Di+"</a>",a+='<div class="dd__item-media"><img src="'+_a()+'" alt="'+e.name+' case study" /></div>',a+="</div>",a+="</div>",a+="</div>"}return a+='<a class="dd__footer" href="#">Check all industries</a>',a+="</div>",a+='<div class="dd__media"><img src="'+_a()+'" alt="'+Ie[rt].name+' case study" /></div>',a+="</div>",a+="</div>",a}function Ri(){let a='<div class="dd dd--simple"'+(V?' data-split="'+V+'"':"")+' data-surface="light">';a+='<div class="dd__body">',a+='<div class="dd__header">',a+='<h2 class="dd__title">Frequently asked questions</h2>',a+='<p class="dd__subtitle">Everything you need to know about the platform. Can’t find what you’re looking for? Contact our support team.</p>',a+="</div>",a+='<div class="dd__list">';for(let t=0;t<_s.length;t++){const e=_s[t],d=t===rt;a+='<div class="dd__item'+(d?" dd__item--on":"")+'" data-idx="'+t+'">',a+='<div class="dd__item-head" role="button" tabindex="0" aria-expanded="'+d+'">',a+='<span class="dd__item-name">'+e.name+"</span>",a+=Pi,a+="</div>",a+='<div class="dd__item-body">',a+='<div class="dd__item-content">',a+='<p class="dd__item-desc">'+e.desc+"</p>",a+="</div>",a+="</div>",a+="</div>"}return a+="</div>",a+="</div>",a+="</div>",a}function fs(a){if(a===rt)return;const t=document.getElementById("dd-preview");if(!t)return;const e=t.querySelectorAll(".dd__item"),d=e[rt];if(d){d.classList.remove("dd__item--on");const r=d.querySelector(".dd__item-head");r&&r.setAttribute("aria-expanded","false")}const o=e[a];if(o){o.classList.add("dd__item--on");const r=o.querySelector(".dd__item-head");r&&r.setAttribute("aria-expanded","true")}if(ke==="rich"){const r=t.querySelector(".dd__media img");if(r){r.style.opacity="0";const s=()=>{r.removeEventListener("transitionend",s),r.src=_a(),r.alt=Ie[a].name+" case study",r.onload=()=>{r.style.opacity="1"},r.complete&&(r.style.opacity="1")};r.addEventListener("transitionend",s)}}rt=a,Js()}function Te(){const a=document.getElementById("dd-preview");a&&(a.innerHTML=ke==="simple"?Ri():Mi(),Oi(),Js())}let fa=!1;function Oi(){if(fa)return;const a=document.getElementById("dd-preview");a&&(fa=!0,a.addEventListener("click",t=>{const e=t.target.closest(".dd__item-head");if(!e)return;const d=e.closest(".dd__item");if(!d)return;const o=parseInt(d.dataset.idx||"0",10);fs(o)}),a.addEventListener("keydown",t=>{if(t.key!=="Enter"&&t.key!==" ")return;const e=t.target.closest(".dd__item-head");if(!e)return;t.preventDefault();const d=e.closest(".dd__item");if(!d)return;const o=parseInt(d.dataset.idx||"0",10);fs(o)}))}function ks(a,t){if(Gt=a<=639?"mobile":a<=1023?"tablet":"desktop",t){const r=t.closest(".lam-device-bar");r&&r.querySelectorAll(".lam-device").forEach(s=>s.classList.remove("on")),t.classList.add("on")}const e=document.getElementById("dd-viewport");if(e){e.setAttribute("data-bp",Gt),Gt==="desktop"?(e.style.width="100%",e.style.maxWidth="none",e.style.margin="0"):(e.style.width=a+"px",e.style.maxWidth="100%",e.style.margin="0 auto");const r=document.getElementById("dd-breakout");r&&(r.style.padding="0")}const d=Gt.charAt(0).toUpperCase()+Gt.slice(1),o=document.getElementById("dd-width-label");o&&(o.textContent=d+" · "+a+"px"),Te()}function Js(){const a=document.getElementById("dd-code");if(!a)return;const t="  ";let e="";ke==="simple"?(e+='<div class="dd dd--simple"'+(V?' data-split="'+V+'"':"")+`>
...
`,e+=t+`</div>
`,e+="</div>"),a.innerHTML=R(e)}function qi(){ke="rich",V="",Gt="desktop",rt=0,fa=!1,ks(1440,document.querySelector("#dd-breakout .lam-device")),Te();const a=document.getElementById("dd-device-bar");a&&a.querySelectorAll(".lam-device").forEach(o=>{o.addEventListener("click",()=>{const r=parseInt(o.dataset.width||"1440",10);a.querySelectorAll(".lam-device").forEach(s=>{s.classList.remove("on"),s.setAttribute("aria-checked","false")}),o.classList.add("on"),o.setAttribute("aria-checked","true"),ks(r,o)})});const t=document.getElementById("dd-variant-pills");t&&D(t,o=>{ke=o.dataset.val||"rich",rt=0,Te()});const e=document.getElementById("dd-split-pills");e&&D(e,o=>{V=o.dataset.val||"",Te()});const d=document.getElementById("dd-copy-btn");d&&d.addEventListener("click",()=>{const o=document.getElementById("dd-code");o&&(S(o.textContent||""),j("Copied!"))})}const Hi=`
<div class="pg-controls">
  <div class="pg-controls__row">
    <span class="pg-controls__label">Layout</span>
...
`,Gi={title:"Deep Dive",desc:"Expand, collapse, explore. Accordion stencil in rich and simple variants.",tabs:["Preview","Specs"],content:[Hi,zi],wide:!0,brandAware:!0,init:qi},We={"getting-started":Gd,"tokens-export":Vd,typography:Xd,spacing:sr,colors:pr,shadows:br,breakpoints:_r,blocks:Br,button:xr,eyebrow:Ar,"look-at-me":Or,"show-and-tell":Nr,island:Xr,field:ai,"smiley-contact-box":li,"learn-more":bi,"card-row":ji,illustrations:Ti,"deep-dive":Gi};window.copyToClipboard=S;window.showToast=j;window.hlHTML=R;window.setupRadioGroup=D;window._juneCopyRootTokens=()=>{const a=Array.from(document.styleSheets).flatMap(t=>{try{return Array.from(t.cssRules)}catch{return[]}}).filter(t=>t instanceof CSSStyleRule&&t.selectorText===":root").map(t=>t.cssText).join(`
`);S(a||":root { /* tokens */ }"),j("Copied :root tokens!")};let ka=!1;function xs(a){a.addEventListener("click",t=>{const e=t.target.closest(".tabs button");if(!e)return;const d=parseInt(e.dataset.tabIdx||"0"),o=e.dataset.tabName;a.querySelectorAll(".tabs button").forEach(s=>{s.classList.remove("on"),s.setAttribute("aria-selected","false"),s.setAttribute("tabindex","-1")}),e.classList.add("on"),e.setAttribute("aria-selected","true"),e.setAttribute("tabindex","0"),a.querySelectorAll(".pane").forEach(s=>s.classList.remove("on"));const r=a.querySelector('.pane[data-pane="'+d+'"]');if(r&&r.classList.add("on"),o){const s=a.getAttribute("data-page-id"),l=o.toLowerCase().replace(/\s+/g,"-").replace(/&/g,"");window.history.replaceState(null,"","#"+s+"-"+l)}}),a.addEventListener("keydown",t=>{const e=t.target.closest(".tabs button");if(!e)return;const d=[...a.querySelectorAll(".tabs button")],o=d.indexOf(e);let r=-1;t.key==="ArrowRight"?r=(o+1)%d.length:t.key==="ArrowLeft"?r=(o-1+d.length)%d.length:t.key==="Home"?r=0:t.key==="End"&&(r=d.length-1),r>=0&&(t.preventDefault(),d[r].focus(),d[r].click())})}document.addEventListener("click",a=>{var e,d,o;const t=a.target;if((e=t.classList)!=null&&e.contains("code-inline__copy")){const r=t.dataset.copy||((o=(d=t.parentElement)==null?void 0:d.textContent)==null?void 0:o.replace(/\s*$/,""))||"";S(r),j("Copied!")}});function Xt(a){const t=We[a];if(!t)return;const e=document.getElementById("page");if(!e)return;document.querySelectorAll(".sidebar__item").forEach(l=>l.classList.toggle("active",l.dataset.page===a));const d=document.querySelector(".content");d&&(d.scrollTop=0);let o="";if(!t.hideHeader){const l=Gs[a];l&&(o+='<span class="page-section">'+l+"</span>"),o+='<div class="page-header">',o+='<h2 class="page-title">'+t.title+"</h2>",o+="</div>",t.desc&&(o+='<p class="page-desc">'+t.desc+"</p>")}let r=0;const s=window.location.hash.slice(1);if(s.startsWith(a+"-")){const l=s.substring(a.length+1),n=t.tabs.findIndex(c=>c.toLowerCase().replace(/\s+/g,"-").replace(/&/g,"")===l);n>=0&&(r=n)}if(t.tabs.length>1&&(o+='<div class="tabs" role="tablist" aria-label="'+(t.title||"Sections")+'">',t.tabs.forEach((l,n)=>{const c="tab-"+a+"-"+n,h="panel-"+a+"-"+n;o+='<button class="'+(n===r?"on":"")+'" data-tab-idx="'+n+'" data-tab-name="'+l+'" role="tab" aria-selected="'+(n===r)+'" id="'+c+'" aria-controls="'+h+'">'+l+"</button>"}),o+="</div>"),t.content&&t.content.length&&t.content.forEach((l,n)=>{const c="tab-"+a+"-"+n,h="panel-"+a+"-"+n;o+='<div class="pane'+(n===r?" on":"")+'" data-pane="'+n+'" role="tabpanel" id="'+h+'" aria-labelledby="'+c+'">'+l+"</div>"}),e.setAttribute("data-page-id",a),t.wide?e.setAttribute("data-wide",""):e.removeAttribute("data-wide"),e.innerHTML=o,document.dispatchEvent(new CustomEvent("brand-aware-change",{detail:!!t.brandAware})),!ka){const l=window.location.hash.slice(1);if(La(l)!==a){const c=new URL(window.location.href);c.hash=a,window.history.pushState({page:a},"",c)}}e.classList.remove("animate"),requestAnimationFrame(()=>{e.classList.add("animate"),_d(),fd(),yd()}),e.querySelectorAll(".tabs button").forEach(l=>l.setAttribute("tabindex",l.classList.contains("on")?"0":"-1")),Ni(),t.init&&t.init()}function Ni(){document.querySelectorAll(".code-inline:not([data-init])").forEach(a=>{a.setAttribute("data-init","1");const t=a.innerHTML.trim(),e=a.dataset.code||t,d=(t||e).replace(/</g,"&lt;").replace(/>/g,"&gt;");a.innerHTML='<span class="code-inline__text">'+R(d)+'</span><span class="code-inline__copy" title="Copy" data-copy="'+e.replace(/"/g,"&quot;")+'"></span>'})}window.renderPage=Xt;document.addEventListener("click",a=>{const t=a.target.closest("[data-navigate]");if(t){a.preventDefault();const e=t.dataset.navigate;if(e){Xt(e);const d=document.querySelector("app-shell");d&&(d.currentPage=e)}}});document.addEventListener("navigate",(a=>{Xt(a.detail)}));document.addEventListener("click",a=>{const e=a.target.closest(".tok:not(.tok--static)");e&&(S(e.textContent||""),j("Copied "+(e.textContent||"")))});document.addEventListener("brand-change",(a=>{const t=document.getElementById("page");t&&t.setAttribute("data-brand",a.detail)}));function La(a){if(!a)return"getting-started";if(We[a])return a;const t=Object.keys(We).sort((e,d)=>d.length-e.length);for(const e of t)if(a.startsWith(e+"-"))return e;return"getting-started"}window.addEventListener("popstate",a=>{var d;ka=!0;const t=window.location.hash.slice(1),e=((d=a.state)==null?void 0:d.page)||La(t);if(We[e]){Xt(e);const o=document.querySelector("sidebar-nav");o&&o.setActive(e)}ka=!1});const Ui=window.location.hash.slice(1),ws=La(Ui),$s=document.querySelector("app-shell");$s?customElements.whenDefined("app-shell").then(async()=>{await $s.updateComplete;const a=document.getElementById("page");a&&xs(a),Xt(ws)}):document.addEventListener("DOMContentLoaded",()=>{const a=document.getElementById("page");a&&xs(a),Xt(ws)});
