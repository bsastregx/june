      ...
      <div class="layout">
        <header class="topbar" role="banner" aria-label="June DS">
          <div class="topbar__left">
            ...
            <img class="topbar__ico" src=${Cd} alt="June DS" />
 ...
 */class pa extends $o{constructor(t){if(super(t),this.it=g,t.type!==xo.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||t==null)return this._t=void 0,this.it=t;if(t===jt)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}pa.directiveName="unsafeHTML",pa.resultType=1;const Ld=wo(pa);function R(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/(&lt;\/?)([\w-]+)/g,'$1<span class="ck">$2</span>').replace(/\s([\w-]+)=/g,' <span class="cv">$1</span>=').replace(/"([^"]*)"/g,'"<span class="cs">$1</span>"').replace(/(&lt;!--.*?--&gt;)/g,'<span class="cc">$1</span>')}var Pd=Object.defineProperty,Dd=Object.getOwnPropertyDescriptor,Fa=(a,t,e,d)=>{for(var o=d>1?void 0:d?Dd(t,e):t,r=a.length-1,s;r>=0;r--)(s=a[r])&&(o=(d?s(t,e,o):s(o))||o);return d&&o&&Pd(t,e,o),o};let Re=class extends M{constructor(){super(...arguments),this.code="",this.label="HTML"}createRenderRoot(){return this}_copy(){S(this.code),j("Copied!")}render(){return u`
    ...
    `}};ds=qd([Q("playground-controls")],ds);const Hd=ht("/hero-logo.png"),zd=`
<style>
